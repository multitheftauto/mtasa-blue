...
*  FILE:        game_sa/CEntitySA.renderfeedback.cpp
...
//
//////////////////////////////////////////////////////////////////////////////////////////
void __cdecl OnMY_CallIdle_Pre( DWORD calledFrom )
{
    TIMING_CHECKPOINT( "+CallIdle1" );
}

void __cdecl OnMY_CallIdle_Post( RwGeometry* pGeometry, DWORD calledFrom )
{
...
//
// TODO: reverse the entity rendering callback.
//
//////////////////////////////////////////////////////////////////////////////////////////
void __cdecl OnMY_CEntity_Render_Pre( CEntitySAInterface* pEntity )
{
...
void __cdecl OnMY_CEntity_Render_Post( void )
{
    if ( ms_Rendering )
    {
        ms_Rendering = NULL;
...
//
//////////////////////////////////////////////////////////////////////////////////////////
void __cdecl OnMY_CEntity_RenderOneNonRoad_Pre( CEntitySAInterface* pEntity )
{
    ms_RenderingOneNonRoad = pEntity;
    CallGameEntityRenderHandler ( ms_RenderingOneNonRoad );
}

void __cdecl OnMY_CEntity_RenderOneNonRoad_Post( CEntitySAInterface* pEntity )
{
...
//
// TODO: reverse the ped rendering routine.
//
//////////////////////////////////////////////////////////////////////////////////////////
void __cdecl OnMY_CVisibilityPlugins_RenderWeaponPedsForPC_Mid( CPedSAInterface* pEntity )
{
...
//
//////////////////////////////////////////////////////////////////////////////////////////
void __cdecl OnMY_CVisibilityPlugins_RenderWeaponPedsForPC_End( void )
{
...
//
//////////////////////////////////////////////////////////////////////////////////////////
void __cdecl OnMY_WinLoop( void )
{
...
//
//////////////////////////////////////////////////////////////////////////////////////////
void __cdecl OnMY_psGrabScreen_GetRect( HWND hWnd, LPRECT pRect )
{
...
bool __cdecl OnMY_psGrabScreen_ShouldUseRect( void )
{
    bool bWindowed;
...
//
//////////////////////////////////////////////////////////////////////////////////////////
void __cdecl OnMY_CClouds_RenderSkyPolys( void )
{
...
//////////////////////////////////////////////////////////////////////////////////////////
//
// CGameSA::SetGameEntityRenderHandler
//
//
//////////////////////////////////////////////////////////////////////////////////////////
void CGameSA::SetGameEntityRenderHandler ( GameEntityRenderHandler * pHandler )
{
...
//////////////////////////////////////////////////////////////////////////////////////////
//
// CGameSA::SetPreRenderSkyHandler
//
//
//////////////////////////////////////////////////////////////////////////////////////////
void CGameSA::SetPreRenderSkyHandler ( PreRenderSkyHandler * pHandler )
{
...
//////////////////////////////////////////////////////////////////////////////////////////
//
// CGameSA::SetIsMinimizedAndNotConnected
//
//
//////////////////////////////////////////////////////////////////////////////////////////
void CGameSA::SetIsMinimizedAndNotConnected ( bool bIsMinimizedAndNotConnected )
{
...
//////////////////////////////////////////////////////////////////////////////////////////
//
// CGameSA::InitHooks_Rendering
//
// Setup hook
//
//////////////////////////////////////////////////////////////////////////////////////////
void CGameSA::InitHooks_Rendering ( void )
{
