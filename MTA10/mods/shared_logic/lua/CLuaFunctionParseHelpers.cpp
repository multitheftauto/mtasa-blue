...
IMPLEMENT_ENUM_BEGIN(eRadioStreamIndex)
    ...
    ADD_ENUM(RADIO_STREAM_KROSE, "KROSE")
    ...
    ADD_ENUM(RADIO_STREAM_SFUR, "SFUR")
    ADD_ENUM(RADIO_STREAM_RADIO_LOS_SANTOS, "Radio Los Santos")
    ADD_ENUM(RADIO_STREAM_RADIO_X, "Radio X")
    ADD_ENUM(RADIO_STREAM_CSR, "CSR")
    ADD_ENUM(RADIO_STREAM_KJAH, "K-JAH")
    ADD_ENUM(RADIO_STREAM_MASTER_SOUNDS, "Master Sounds")
