...
class CRenderWare {
	public:
    virtual void				ModelInfoTXDAddTextures		( std::list < RwTexture* >& textures, unsigned short usModelID, bool bMakeCopy ) = 0;
    virtual void				ModelInfoTXDRemoveTextures	( std::list < RwTexture* >& textures, unsigned short usModelID, bool bDestroy, bool bKeepRaster = false ) = 0;
