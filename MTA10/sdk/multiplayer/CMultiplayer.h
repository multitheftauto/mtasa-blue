...
public:
    ...
    virtual void                        SetPlayer ( class CPlayerPed * player )=0;
...
{
public:
    virtual class CRemoteDataStorage *  AddRemoteDataStorage ( class CPlayerPed * player )=0;
    virtual void                        RemoveRemoteDataStorage ( class CRemoteDataStorage * data )=0;
    ...
    virtual bool                        GetExplosionsDisabled ( void ) = 0;
    ...
    virtual float                       GetGlobalGravity ( void ) = 0;
    virtual void                        SetGlobalGravity ( float fGravity ) = 0;

    virtual float                       GetLocalPlayerGravity ( void ) = 0;
    ...
    virtual bool                        IsCustomCameraRotationEnabled ( void ) = 0;
