    ...
    m_pPedSound ( NULL )
{
    ...
    MemSet8 ( this->m_pWeapons, 0, sizeof ( CWeaponSA* ) * WEAPONSLOT_MAX );
}
...
void CPedSA::Respawn(CVector * position, bool bCameraCut)
{
    ...
    if ( !bCameraCut )
    {
        ...
        MemCpy8 ( (void*)0x4422EA, szCode, 20 );
    }
...
{
    MemCpy8 (vector,&(((CPedSAInterface *)this->GetInterface())->ObjectiveVector),sizeof(CVector));
}
*/
