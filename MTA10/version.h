...
#define _NETCODE_VERSION_BRANCH_ID      0x3         // Use 0x1 - 0xF to indicate an incompatible branch is being used (0x0 is reserved, 0x4 is trunk)
#define _CLIENT_NET_MODULE_VERSION      0x034       // (0x000 - 0xfff) Lvl9 wizards only
#define _NETCODE_VERSION                0x1B8       // (0x000 - 0xfff) Increment when net messages change (pre-release)
