...
public:
    ...
    HRESULT __stdcall   SetVectorArray  ( D3DXHANDLE hParameter, CONST D3DXVECTOR4* pVector, UINT Count)    { return m_pOriginal->SetVectorArray( hParameter, pVector, Count ); }
    HRESULT __stdcall   GetVectorArray  ( D3DXHANDLE hParameter, D3DXVECTOR4* pVector, UINT Count)          { return m_pOriginal->GetVectorArray( hParameter, pVector, Count ); }
    ...
    HRESULT __stdcall   SetMatrixArray  ( D3DXHANDLE hParameter, CONST D3DXMATRIX* pMatrix, UINT Count)     { return m_pOriginal->SetMatrixArray( hParameter, pMatrix, Count ); }
    ...
    HRESULT __stdcall   SetMatrixPointerArray ( D3DXHANDLE hParameter, CONST D3DXMATRIX** ppMatrix, UINT Count)          { return m_pOriginal->SetMatrixPointerArray( hParameter, ppMatrix, Count ); }
    HRESULT __stdcall   GetMatrixPointerArray ( D3DXHANDLE hParameter, D3DXMATRIX** ppMatrix, UINT Count)   { return m_pOriginal->GetMatrixPointerArray( hParameter, ppMatrix, Count ); }
    ...
    HRESULT __stdcall   SetMatrixTransposeArray ( D3DXHANDLE hParameter, CONST D3DXMATRIX* pMatrix, UINT Count)          { return m_pOriginal->SetMatrixTransposeArray( hParameter, pMatrix, Count ); }
    HRESULT __stdcall   GetMatrixTransposeArray ( D3DXHANDLE hParameter, D3DXMATRIX* pMatrix, UINT Count)   { return m_pOriginal->GetMatrixTransposeArray( hParameter, pMatrix, Count ); }
    HRESULT __stdcall   SetMatrixTransposePointerArray ( D3DXHANDLE hParameter, CONST D3DXMATRIX** ppMatrix, UINT Count) { return m_pOriginal->SetMatrixTransposePointerArray( hParameter, ppMatrix, Count ); }
    HRESULT __stdcall   GetMatrixTransposePointerArray ( D3DXHANDLE hParameter, D3DXMATRIX** ppMatrix, UINT Count)       { return m_pOriginal->GetMatrixTransposePointerArray( hParameter, ppMatrix, Count ); }
    ...
    HRESULT __stdcall   FindNextValidTechnique ( D3DXHANDLE hTechnique, D3DXHANDLE *pTechnique) { return m_pOriginal->FindNextValidTechnique( hTechnique, pTechnique ); }
    ...
    HRESULT __stdcall   SetRawValue     ( D3DXHANDLE hParameter, LPCVOID pData, UINT ByteOffset, UINT Bytes)   { return m_pOriginal->SetRawValue( hParameter, pData, ByteOffset, Bytes ); }
