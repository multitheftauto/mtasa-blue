/************************************************************************
	filename: 	CEGUIListboxNumberItem.h
	created:	25/2/2006
...
*************************************************************************/
#ifndef _CEGUIListboxNumberItem_h_
#define _CEGUIListboxNumberItem_h_
...
*/
class CEGUIEXPORT ListboxNumberItem : public ListboxItem
{
public:
	/*************************************************************************
		Constants
	...
	*/
	ListboxNumberItem(const String& text, uint item_id = 0, void* item_data = NULL, bool disabled = false, bool auto_delete = true);
...
#endif	// end of guard _CEGUIListboxNumberItem_h_
