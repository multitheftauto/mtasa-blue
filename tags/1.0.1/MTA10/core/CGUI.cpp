...
void CLocalGUI::CreateWindows ( void )
{
    ...
    m_pLabelVersionTag = reinterpret_cast < CGUILabel* > ( pGUI->CreateLabel ( SString("MTA:SA %s %s", MTA_DM_VERSIONSTRING, stricmp ( MTA_DM_BUILDTYPE, "Release" ) ? MTA_DM_BUILDTYPE : "" ).c_str() ) );
