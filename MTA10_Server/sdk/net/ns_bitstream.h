...
*  FILE:        sdk/net/ns_bitstream.h
*  PURPOSE:     Net server bitstream interface
*
*  Multi Theft Auto is available from http://www.multitheftauto.com/
*
*****************************************************************************/

#ifndef __NS_BITSTREAM_H
#define __NS_BITSTREAM_H

class NetServerBitStreamInterface
{
public:
    virtual             ~NetServerBitStreamInterface    ( void ) {};

    virtual int         GetReadOffset                   ( void ) = 0;

	virtual void        Reset                           ( void ) = 0;
    virtual void        ResetReadPointer                ( void ) = 0;
	
	//virtual void        Write                           ( const bool& input ) = 0;
	...
	//virtual bool        Read                            ( bool& output ) = 0;
