                    ...
                    if ( iLength > 3 && strString [0] == '^' && strString [2] == '^' && strString [1] != '^' )
                    {
                        switch ( strString [1] )
                        {
                            ...
                            case 'R': // resource
                            {
                                ...
                                {
                                    g_pGame->GetScriptDebugging ( )->LogError ( NULL, SString ( "Invalid resource specified in JSON string '%s'.", strString ) );
                                    m_iType = LUA_TNIL;
                                }
                                break;
                            }
                            case 'T':   // Table reference
                            {
                                ...
                                {
                                    g_pGame->GetScriptDebugging ( )->LogError ( NULL, SString ( "Invalid table reference specified in JSON string '%s'.", strString ) );
                                    m_iType = LUA_TNIL;
                                }
                                break;
                            }
