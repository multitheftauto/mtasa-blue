...
CResourceClientScriptItem::CResourceClientScriptItem ( CResource * resource, char * szShortName, char * szResourceFileName ) : CResourceFile ( resource, szShortName, szResourceFileName )
{
