                        ...
                        if ( !CVehicleManager::IsTrailer ( usVehicleModel ) )
                        {
                            ...
                            if ( pPlayer->GetVehicleAction () == CPlayer::VEHICLEACTION_NONE )
                            {
                                ...
                                if ( !pPlayer->GetOccupiedVehicle () && !pPlayer->GetEnteringVehicle () )
                                {
                                    ...
                                    if ( usVehicleModel == VT_RCBARON || ( ( pPlayer->IsInWater() || Packet.GetOnWater() ) &&
                                                                    ( usVehicleModel == VT_SKIMMER ||
                                    ...
                                    // If he's going to be jacking the driver, lets make sure he's very close to it
                                    // Otherwise, point him to a free passenger seat, if his favorite seat is taken
                                    if ( pOccupant )
                                    {
                                        if ( ucSeat == 0 )
                                            fCutoffDistance = 10.0f;
                                    ...
                                    // Make sure we actually have a valid seat, due to the check above
                                    if ( ucSeat <= 8 )
                                    {
                                        ...
                                        failReason = VEHICLE_INOUT_FAIL_SEAT;
                                }
                                else
