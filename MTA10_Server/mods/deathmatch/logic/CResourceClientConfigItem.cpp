...
CResourceClientConfigItem::CResourceClientConfigItem ( CResource * resource, char * szShortName, char * szResourceFileName ) : CResourceFile ( resource, szShortName, szResourceFileName )
{
    m_pXMLFile = NULL;
    m_pXMLRootNode = NULL;
    m_bInvalid = false;
