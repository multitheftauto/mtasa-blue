...
CResourceHTMLItem::CResourceHTMLItem ( CResource * resource, char * szShortName, char * szResourceFileName, bool bIsDefault, bool bIsRaw, bool bRestricted ) : CResourceFile ( resource, szShortName, szResourceFileName )
{
    m_bIsRaw = bIsRaw;
    m_szBuffer = NULL;
