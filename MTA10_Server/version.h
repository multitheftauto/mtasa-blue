...
#define _SERVER_NET_MODULE_VERSION      0x02F       // (0x000 - 0xfff) Lvl9 wizards only
#define _NETCODE_VERSION                0x1AC       // (0x000 - 0xfff) Increment when net messages change (pre-release)
