...
public:
    ...
    virtual CGUIFont*           CreateFnt               ( const char* szFontName, const char* szFontFile, unsigned int* uiGlyphs, unsigned int uSize = 8, unsigned int uFlags = 0, bool bAutoScale = false ) = 0;
