...
CSyncDebug::CSyncDebug ( CClientManager* pManager )
{
    ...
    m_uiLastBitsReceived = m_uiBitsReceived = stats.bytesReceived * 8;//  stats.runningTotal [ NS_ACTUAL_BYTES_RECEIVED ] * 8;
    m_uiLastBitsSent = m_uiBitsSent = stats.bytesSent * 8;//stats.runningTotal [ NS_ACTUAL_BYTES_SENT ] * 8;
...
void CSyncDebug::OnUpdate ( void )
{
    ...
    m_uiBitsReceived = stats.bytesReceived * 8;
    m_uiBitsSent = stats.bytesSent * 8;
}
