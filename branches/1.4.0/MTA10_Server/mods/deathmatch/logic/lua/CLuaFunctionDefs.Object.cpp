...
*  FILE:        mods/deathmatch/logic/lua/CLuaFunctionDefs.Object.cpp
...
int CLuaFunctionDefs::GetObjectRotation ( lua_State* luaVM )
{
    CObject* pObject;
...
int CLuaFunctionDefs::SetObjectRotation ( lua_State* luaVM )
{
    CElement* pElement;
    CVector vecRotation;
