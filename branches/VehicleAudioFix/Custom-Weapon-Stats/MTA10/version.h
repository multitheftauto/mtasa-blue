...
#define _CLIENT_NET_MODULE_VERSION      0x03C       // (0x000 - 0xfff) Lvl9 wizards only
#define _NETCODE_VERSION                0x1C3       // (0x000 - 0xfff) Increment when net messages change (pre-release)
