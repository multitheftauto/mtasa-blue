...
int CLuaWorldDefs::SetTrainTrackPosition ( lua_State* luaVM )
{
...
int CLuaWorldDefs::GetTrainTrackPosition ( lua_State* luaVM )
{
    unsigned char ucTrackID = 0;
    unsigned int uiTrackNode = 0;
    CVector vecPosition;
...
int CLuaWorldDefs::CreateTrainTrack ( lua_State* luaVM )
{
...
int CLuaWorldDefs::SetTrainTrackLength ( lua_State* luaVM )
{
    float fLength = 0.0f;
    CTrainTrack * pTrainTrack = NULL;
    CScriptArgReader argStream ( luaVM );
...
int CLuaWorldDefs::GetTrainTrackLength ( lua_State* luaVM )
{
    float fLength = 0.0f;
    CTrainTrack * pTrainTrack = NULL;
    CScriptArgReader argStream ( luaVM );
...
int CLuaWorldDefs::SetTrainTrackNumberOfNodes ( lua_State* luaVM )
{
...
int CLuaWorldDefs::GetTrainTrackNumberOfNodes ( lua_State* luaVM )
{
    unsigned int uiNodes = 0;
    CTrainTrack * pTrainTrack = NULL;
    CScriptArgReader argStream ( luaVM );
...
int CLuaWorldDefs::GetTrainTrackID ( lua_State* luaVM )
{
