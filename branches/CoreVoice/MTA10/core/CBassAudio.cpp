...
#include <StdInc.h>
#include <process.h>
#include "../../vendor/bass/tags.h"
#include "../../vendor/bass/bassmix.h"
#include "../../vendor/bass/basswma.h"
...
void CBassAudio::Destroy ( void )
{
    ...
    if ( m_pSound )
    {
        ...
        //GetManager()->GetSoundManager()->QueueAudioStop( this );
    }
    else
        delete this;
}
