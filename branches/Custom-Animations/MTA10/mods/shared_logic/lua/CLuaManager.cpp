...
void CLuaManager::LoadCFunctions ( void )
{
    ...
    CLuaCFunctions::AddFunction ( "engineLoadAnimation", CLuaFunctionDefs::EngineLoadAnimation );
    CLuaCFunctions::AddFunction ( "engineUnloadAnimation", CLuaFunctionDefs::EngineUnloadAnimation );
