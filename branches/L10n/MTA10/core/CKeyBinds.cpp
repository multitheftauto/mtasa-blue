...
{
    { "fire",                   FIRE,                   CONTROL_FOOT,    false, true, _d("Fire") },
    { "next_weapon",            NEXT_WEAPON,            CONTROL_FOOT,    false, true, _d("Next weapon") },
    { "previous_weapon",        PREVIOUS_WEAPON,        CONTROL_FOOT,    false, true, _d("Previous weapon") },
    { "forwards",               FORWARDS,               CONTROL_FOOT,    false, true, _d("Forwards") },
    { "backwards",              BACKWARDS,              CONTROL_FOOT,    false, true, _d("Backwards") },
    { "left",                   LEFT,                   CONTROL_FOOT,    false, true, _d("Left") },
    { "right",                  RIGHT,                  CONTROL_FOOT,    false, true, _d("Right") },
    { "zoom_in",                ZOOM_IN,                CONTROL_FOOT,    false, true, _d("Zoom in") },
    { "zoom_out",               ZOOM_OUT,               CONTROL_FOOT,    false, true, _d("Zoom out") },
    { "enter_exit",             ENTER_EXIT,             CONTROL_BOTH,    false, true, _d("Enter/Exit") },
    { "change_camera",          CHANGE_CAMERA,          CONTROL_BOTH,    false, true, _d("Change camera") }, // 10
    { "jump",                   JUMP,                   CONTROL_FOOT,    false, true, _d("Jump") },
    { "sprint",                 SPRINT,                 CONTROL_FOOT,    false, true, _d("Sprint") },
    { "look_behind",            LOOK_BEHIND,            CONTROL_FOOT,    false, true, _d("Look behind") },
    { "crouch",                 CROUCH,                 CONTROL_FOOT,    false, true, _d("Crouch") },
    { "action",                 ACTION,                 CONTROL_FOOT,    false, true, _d("Action") },
    { "walk",                   WALK,                   CONTROL_FOOT,    false, true, _d("Walk") },
    { "vehicle_fire",           VEHICLE_FIRE,           CONTROL_VEHICLE, false, true, _d("Vehicle fire") },
    { "vehicle_secondary_fire", VEHICLE_SECONDARY_FIRE, CONTROL_VEHICLE, false, true, _d("Vehicle secondary fire") },
    { "vehicle_left",           VEHICLE_LEFT,           CONTROL_VEHICLE, false, true, _d("Vehicle left") },
    { "vehicle_right",          VEHICLE_RIGHT,          CONTROL_VEHICLE, false, true, _d("Vehicle right") }, // 20
    { "steer_forward",          STEER_FORWARDS_DOWN,    CONTROL_VEHICLE, false, true, _d("Steer forwards/down") },
    { "steer_back",             STEER_BACK_UP,          CONTROL_VEHICLE, false, true, _d("Steer backwards/up") },
    { "accelerate",             ACCELERATE,             CONTROL_VEHICLE, false, true, _d("Accelerate") },
    { "brake_reverse",          BRAKE_REVERSE,          CONTROL_VEHICLE, false, true, _d("Brake/Reverse") },
    { "radio_next",             RADIO_NEXT,             CONTROL_VEHICLE, false, true, _d("Radio next") },
    { "radio_previous",         RADIO_PREVIOUS,         CONTROL_VEHICLE, false, true, _d("Radio previous") },
    { "radio_user_track_skip",  RADIO_USER_TRACK_SKIP,  CONTROL_VEHICLE, false, true, _d("Radio user track skip") },
    { "horn",                   HORN,                   CONTROL_VEHICLE, false, true, _d("Horn") },
    { "sub_mission",            SUB_MISSION,            CONTROL_VEHICLE, false, true, _d("Sub-mission") },
    { "handbrake",              HANDBRAKE,              CONTROL_VEHICLE, false, true, _d("Handbrake") }, // 30
    { "vehicle_look_left",      VEHICLE_LOOK_LEFT,      CONTROL_VEHICLE, false, true, _d("Vehicle look left") },
    { "vehicle_look_right",     VEHICLE_LOOK_RIGHT,     CONTROL_VEHICLE, false, true, _d("Vehicle look right") },
    { "vehicle_look_behind",    VEHICLE_LOOK_BEHIND,    CONTROL_VEHICLE, false, true, _d("Vehicle look behind") },
    { "vehicle_mouse_look",     VEHICLE_MOUSE_LOOK,     CONTROL_VEHICLE, false, true, _d("Vehicle mouse look") },
    { "special_control_left",   SPECIAL_CONTROL_LEFT,   CONTROL_VEHICLE, false, true, _d("Special control left") },
    { "special_control_right",  SPECIAL_CONTROL_RIGHT,  CONTROL_VEHICLE, false, true, _d("Special control right") },
    { "special_control_down",   SPECIAL_CONTROL_DOWN,   CONTROL_VEHICLE, false, true, _d("Special control down") },
    { "special_control_up",     SPECIAL_CONTROL_UP,     CONTROL_VEHICLE, false, true, _d("Special control up") },
    { "aim_weapon",             AIM_WEAPON,             CONTROL_FOOT,    false, true, _d("Aim weapon") },
    { "conversation_yes",       CONVERSATION_YES,       CONTROL_FOOT,    false, true, _d("Conversation yes") }, // 40
    { "conversation_no",        CONVERSATION_NO,        CONTROL_FOOT,    false, true, _d("Conversation no") },
    { "group_control_forwards", GROUP_CONTROL_FORWARDS, CONTROL_FOOT,    false, true, _d("Group control forwards") },
    { "group_control_back",     GROUP_CONTROL_BACK,     CONTROL_FOOT,    false, true, _d("Group control backwards") },
