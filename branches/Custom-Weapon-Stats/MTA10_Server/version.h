...
#define _SERVER_NET_MODULE_VERSION      0x03C       // (0x000 - 0xfff) Lvl9 wizards only
#define _NETCODE_VERSION                0x1C2       // (0x000 - 0xfff) Increment when net messages change (pre-release)
#define MTA_DM_BITSTREAM_VERSION        0x018       // (0x000 - 0xfff) Increment when net messages change (post-release). (Changing will also require additional backward compatibility code).
