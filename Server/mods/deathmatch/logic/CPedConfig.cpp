 ...
 *  FILE:        Server/mods/deathmatch/logic/CPedConfig.cpp
...
CPedConfig::CPedConfig(std::string filePath) : m_filePath(std::move(filePath))
{
}
...
bool CPedConfig::IsValidModel(std::uint32_t modelId) const noexcept
{
