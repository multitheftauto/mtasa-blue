 ...
 *  FILE:        Server/mods/deathmatch/logic/CVehicleManager.cpp
...
// Generated by Client\utils\gentable\gentable_vehattr.cpp
...
CVehicle* CVehicleManager::Create(CElement* pParent, ushort usModel, uchar ucVariant, uchar ucVariant2)
{
...
bool CVehicleManager::IsValidModel(ushort usModel)
{
    return usModel >= 400 && usModel <= 611;
}

eVehicleType CVehicleManager::GetVehicleType(ushort usModel)
{
...
bool CVehicleManager::IsValidUpgrade(ushort usModel)
{
    return usModel >= 1000 && usModel <= 1193;
}

uchar CVehicleManager::GetMaxPassengers(ushort usModel)
{
    if (IsValidModel(usModel))
    {
...
void CVehicleManager::GetRandomVariation(ushort usModel, uchar& ucVariant, uchar& ucVariant2)
{
    RandomizeRandomSeed();
    ucVariant = 255;
    ucVariant2 = 255;
...
bool CVehicleManager::HasTurret(ushort usModel)
{
    return (IsValidModel(usModel) && (g_ulVehicleAttributes[usModel - 400] & VEHICLE_HAS_TURRENT));
}

bool CVehicleManager::HasSirens(ushort usModel)
{
    return (IsValidModel(usModel) && (g_ulVehicleAttributes[usModel - 400] & VEHICLE_HAS_SIRENS));
}

bool CVehicleManager::HasTaxiLight(ushort usModel)
{
    return (IsValidModel(usModel) && (g_ulVehicleAttributes[usModel - 400] & VEHICLE_HAS_TAXI_LIGHTS));
}

bool CVehicleManager::HasLandingGears(ushort usModel)
{
    return (IsValidModel(usModel) && (g_ulVehicleAttributes[usModel - 400] & VEHICLE_HAS_LANDING_GEARS));
}

bool CVehicleManager::HasAdjustableProperty(ushort usModel)
{
    return (IsValidModel(usModel) && (g_ulVehicleAttributes[usModel - 400] & VEHICLE_HAS_ADJUSTABLE_PROPERTY));
}

bool CVehicleManager::HasSmokeTrail(ushort usModel)
{
    return (IsValidModel(usModel) && (g_ulVehicleAttributes[usModel - 400] & VEHICLE_HAS_SMOKE_TRAIL));
}

bool CVehicleManager::IsTrailer(ushort usModel)
{
    return (IsValidModel(usModel) && (gs_vehicleTypes[usModel - 400] == VEHICLE_TRAILER));
}

bool CVehicleManager::HasDamageModel(ushort usModel)
{
...
bool CVehicleManager::HasDoors(ushort usModel)
{
...
CVehicleColor CVehicleManager::GetRandomColor(ushort usModel)
{
    return m_ColorManager.GetRandomColor(usModel);
}

void CVehicleManager::GetVehiclesOfType(ushort usModel, lua_State* luaVM)
{
    assert(luaVM);
