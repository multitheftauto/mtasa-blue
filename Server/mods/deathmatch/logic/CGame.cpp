...
void CGame::AddBuiltInEvents(void)
{
    ...
    m_Events.AddEvent("onElementDimensionChange", "oldDimension, newDimension", NULL, false);
    m_Events.AddEvent("onElementInteriorChange", "oldInterior, newInterior", NULL, false);
