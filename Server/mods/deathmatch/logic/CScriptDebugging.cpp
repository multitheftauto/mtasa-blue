...
void CScriptDebugging::Broadcast(const CPacket& Packet, unsigned int uiMinimumDebugLevel)
{
    ...
    {
        bool sufficientDebugLevel = CheckForSufficientDebugLevel(static_cast<std::uint8_t>(pPlayer->m_uiScriptDebugLevel), static_cast<std::uint8_t>(uiMinimumDebugLevel));
