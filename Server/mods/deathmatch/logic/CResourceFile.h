...
protected:
    ...
    uint64                          m_uiFileSizeHint;
    std::filesystem::file_time_type m_lastWriteTime{};
    uint64                          m_lastFileSize{0};
    bool                            m_hasFileMetadata{false};
...
public:
    ...
    std::filesystem::file_time_type GetLastWriteTime() const noexcept { return m_lastWriteTime; }
    void                            SetLastWriteTime(std::filesystem::file_time_type writeTime) noexcept { m_lastWriteTime = writeTime; }
    uint64                          GetLastFileSize() const noexcept { return m_lastFileSize; }
    void                            SetLastFileSize(uint64 fileSize) noexcept { m_lastFileSize = fileSize; }
    bool                            HasFileMetadata() const noexcept { return m_hasFileMetadata; }
    void                            SetHasFileMetadata(bool hasMetadata) noexcept { m_hasFileMetadata = hasMetadata; }
