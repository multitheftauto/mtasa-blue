...
public:
    ...
    void SetCustomData(const char* szName, const CLuaArgument& Variable, ESyncType syncType = ESyncType::SYNC_BROADCAST, CPlayer* pClient = NULL, bool bTriggerEvent = true);
