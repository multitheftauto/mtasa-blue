...
public:
    ...
    const CVector4D&   GetVector() const noexcept { return vectorData; }
    const CMatrix*     GetMatrix() const noexcept { return matrixData; }
    ...
    [[nodiscard]] bool IsMatrix() const noexcept { return m_iType == LUA_TMATRIX && matrixData; }
...
private:
    ...
    CVector4D      vectorData{};
    CMatrix*       matrixData{nullptr};
