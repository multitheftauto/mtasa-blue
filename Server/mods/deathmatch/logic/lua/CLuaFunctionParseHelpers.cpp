...
IMPLEMENT_ENUM_CLASS_BEGIN(IDiscord::DiscordEvent)
ADD_ENUM(IDiscord::DiscordEvent::on_voice_state_update, "voice_state_update")
ADD_ENUM(IDiscord::DiscordEvent::on_voice_client_disconnect, "voice_client_disconnect")
ADD_ENUM(IDiscord::DiscordEvent::on_voice_client_speaking, "voice_client_speaking")
ADD_ENUM(IDiscord::DiscordEvent::on_log, "log")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_join_request_delete, "guild_join_request_delete")
ADD_ENUM(IDiscord::DiscordEvent::on_interaction_create, "interaction_create")
ADD_ENUM(IDiscord::DiscordEvent::on_slashcommand, "slashcommand")
ADD_ENUM(IDiscord::DiscordEvent::on_button_click, "button_click")
ADD_ENUM(IDiscord::DiscordEvent::on_autocomplete, "autocomplete")
ADD_ENUM(IDiscord::DiscordEvent::on_select_click, "select_click")
ADD_ENUM(IDiscord::DiscordEvent::on_message_context_menu, "message_context_menu")
ADD_ENUM(IDiscord::DiscordEvent::on_user_context_menu, "user_context_menu")
ADD_ENUM(IDiscord::DiscordEvent::on_form_submit, "form_submit")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_delete, "guild_delete")
ADD_ENUM(IDiscord::DiscordEvent::on_channel_delete, "channel_delete")
ADD_ENUM(IDiscord::DiscordEvent::on_channel_update, "channel_update")
ADD_ENUM(IDiscord::DiscordEvent::on_ready, "ready")
ADD_ENUM(IDiscord::DiscordEvent::on_message_delete, "message_delete")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_member_remove, "guild_member_remove")
ADD_ENUM(IDiscord::DiscordEvent::on_resumed, "resumed")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_role_create, "guild_role_create")
ADD_ENUM(IDiscord::DiscordEvent::on_typing_start, "typing_start")
ADD_ENUM(IDiscord::DiscordEvent::on_message_reaction_add, "message_reaction_add")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_members_chunk, "guild_members_chunk")
ADD_ENUM(IDiscord::DiscordEvent::on_message_reaction_remove, "message_reaction_remove")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_create, "guild_create")
ADD_ENUM(IDiscord::DiscordEvent::on_channel_create, "channel_create")
ADD_ENUM(IDiscord::DiscordEvent::on_message_reaction_remove_emoji, "message_reaction_remove_emoji")
ADD_ENUM(IDiscord::DiscordEvent::on_message_delete_bulk, "message_delete_bulk")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_role_update, "guild_role_update")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_role_delete, "guild_role_delete")
ADD_ENUM(IDiscord::DiscordEvent::on_channel_pins_update, "channel_pins_update")
ADD_ENUM(IDiscord::DiscordEvent::on_message_reaction_remove_all, "message_reaction_remove_all")
ADD_ENUM(IDiscord::DiscordEvent::on_voice_server_update, "voice_server_update")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_emojis_update, "guild_emojis_update")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_stickers_update, "guild_stickers_update")
ADD_ENUM(IDiscord::DiscordEvent::on_presence_update, "presence_update")
ADD_ENUM(IDiscord::DiscordEvent::on_webhooks_update, "webhooks_update")
ADD_ENUM(IDiscord::DiscordEvent::on_automod_rule_create, "automod_rule_create")
ADD_ENUM(IDiscord::DiscordEvent::on_automod_rule_update, "automod_rule_update")
ADD_ENUM(IDiscord::DiscordEvent::on_automod_rule_delete, "automod_rule_delete")
ADD_ENUM(IDiscord::DiscordEvent::on_automod_rule_execute, "automod_rule_execute")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_member_add, "guild_member_add")
ADD_ENUM(IDiscord::DiscordEvent::on_invite_delete, "invite_delete")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_update, "guild_update")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_integrations_update, "guild_integrations_update")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_member_update, "guild_member_update")
ADD_ENUM(IDiscord::DiscordEvent::on_invite_create, "invite_create")
ADD_ENUM(IDiscord::DiscordEvent::on_message_update, "message_update")
ADD_ENUM(IDiscord::DiscordEvent::on_user_update, "user_update")
ADD_ENUM(IDiscord::DiscordEvent::on_message_create, "message_create")
ADD_ENUM(IDiscord::DiscordEvent::on_message_poll_vote_add, "message_poll_vote_add")
ADD_ENUM(IDiscord::DiscordEvent::on_message_poll_vote_remove, "message_poll_vote_remove")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_audit_log_entry_create, "guild_audit_log_entry_create")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_ban_add, "guild_ban_add")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_ban_remove, "guild_ban_remove")
ADD_ENUM(IDiscord::DiscordEvent::on_integration_create, "integration_create")
ADD_ENUM(IDiscord::DiscordEvent::on_integration_update, "integration_update")
ADD_ENUM(IDiscord::DiscordEvent::on_integration_delete, "integration_delete")
ADD_ENUM(IDiscord::DiscordEvent::on_thread_create, "thread_create")
ADD_ENUM(IDiscord::DiscordEvent::on_thread_update, "thread_update")
ADD_ENUM(IDiscord::DiscordEvent::on_thread_delete, "thread_delete")
ADD_ENUM(IDiscord::DiscordEvent::on_thread_list_sync, "thread_list_sync")
ADD_ENUM(IDiscord::DiscordEvent::on_thread_member_update, "thread_member_update")
ADD_ENUM(IDiscord::DiscordEvent::on_thread_members_update, "thread_members_update")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_scheduled_event_create, "guild_scheduled_event_create")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_scheduled_event_update, "guild_scheduled_event_update")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_scheduled_event_delete, "guild_scheduled_event_delete")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_scheduled_event_user_add, "guild_scheduled_event_user_add")
ADD_ENUM(IDiscord::DiscordEvent::on_guild_scheduled_event_user_remove, "guild_scheduled_event_user_remove")
ADD_ENUM(IDiscord::DiscordEvent::on_voice_buffer_send, "voice_buffer_send")
ADD_ENUM(IDiscord::DiscordEvent::on_voice_user_talking, "voice_user_talking")
ADD_ENUM(IDiscord::DiscordEvent::on_voice_ready, "voice_ready")
ADD_ENUM(IDiscord::DiscordEvent::on_voice_receive, "voice_receive")
ADD_ENUM(IDiscord::DiscordEvent::on_voice_receive_combined, "voice_receive_combined")
ADD_ENUM(IDiscord::DiscordEvent::on_voice_track_marker, "voice_track_marker")
ADD_ENUM(IDiscord::DiscordEvent::on_stage_instance_create, "stage_instance_create")
ADD_ENUM(IDiscord::DiscordEvent::on_stage_instance_update, "stage_instance_update")
ADD_ENUM(IDiscord::DiscordEvent::on_stage_instance_delete, "stage_instance_delete")
ADD_ENUM(IDiscord::DiscordEvent::on_entitlement_create, "entitlement_create")
ADD_ENUM(IDiscord::DiscordEvent::on_entitlement_update, "entitlement_update")
ADD_ENUM(IDiscord::DiscordEvent::on_entitlement_delete, "entitlement_delete")
IMPLEMENT_ENUM_CLASS_END("discord-event")
