...
public:
    explicit CMapInfoPacket(std::uint8_t ucWeather, std::uint8_t ucWeatherBlendingTo, std::uint8_t ucBlendedWeatherHour, std::uint8_t ucClockHour,
                            ...
                            std::uint16_t usFPSLimit = 36, bool bCloudsEnabled = true, float fJetpackMaxHeight = 100, bool bOverrideWaterColor = false,
                            std::uint8_t ucWaterRed = 0, std::uint8_t ucWaterGreen = 0, std::uint8_t ucWaterBlue = 0, std::uint8_t ucWaterAlpha = 0,
                            bool bInteriorSoundsEnabled = true, bool bOverrideRainLevel = false, float fRainLevel = 0, bool bOverrideSunSize = false,
                            float fSunSize = 0, bool bOverrideSunColor = false, std::uint8_t ucSunCoreR = 0, std::uint8_t ucSunCoreG = 0,
                            std::uint8_t ucSunCoreB = 0, std::uint8_t ucSunCoronaR = 0, std::uint8_t ucSunCoronaG = 0, std::uint8_t ucSunCoronaB = 0,
