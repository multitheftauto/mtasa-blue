...
class CConsoleClear : public CPacket
{
public:
    CConsoleClear() {};

    // Console uses low priority channel to avoid getting queued behind large map downloads #6877
    ePacketID               GetPacketID(void) const { return PACKET_ID_CONSOLE_CLEAR; };
