...
CResourceClientConfigItem::CResourceClientConfigItem ( CResource * resource, const char * szShortName, const char * szResourceFileName, const std::list<std::unique_ptr<CXMLAttribute>>& xmlAttributes ) : CResourceFile ( resource, szShortName, szResourceFileName, xmlAttributes )
{
    m_pXMLFile = NULL;
    m_pXMLRootNode = NULL;
    m_bInvalid = false;
