...
public:
    ...
    static bool ResetModelHandling(std::uint32_t uiModel);
    static bool ResetModelHandlingProperty(std::uint32_t uiModel, eHandlingProperty eProperty);
    static bool SetModelHandling(std::uint32_t uiModel, eHandlingProperty eProperty, float fValue);
    static bool SetModelHandling(std::uint32_t uiModel, eHandlingProperty eProperty, CVector vecValue);
    static bool SetModelHandling(std::uint32_t uiModel, eHandlingProperty eProperty, std::string strValue);
    static bool SetModelHandling(std::uint32_t uiModel, eHandlingProperty eProperty, unsigned int uiValue);
    static bool SetModelHandling(std::uint32_t uiModel, eHandlingProperty eProperty, unsigned char ucValue);
