...
void CLuaCompatibilityDefs::LoadFunctions()
{
    ...
    constexpr static const std::pair<const char*, lua_CFunction> functions[]{
        ...
        {"getVehicleIDFromName", ArgumentParserWarn<false, CLuaVehicleDefs::GetVehicleModelFromName>},
        {"getVehicleNameFromID", ArgumentParserWarn<false, CLuaVehicleDefs::GetVehicleNameFromModel>},
