...
public:
    ...
    static std::variant<std::uint32_t, bool> RequestModel(lua_State* luaVM, std::string modelType, std::optional<std::uint32_t> parentModelId,
                                                          std::optional<std::string> nameOpt, std::optional<std::uint32_t> requestedId = std::nullopt);
    ...
    static std::variant<std::string, bool>   GetModelName(std::uint32_t modelId);
    static std::variant<std::uint32_t, bool> GetModelFromName(std::string name);
