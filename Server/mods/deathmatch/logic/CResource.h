...
public:
    ...
    CXMLNode* GetSettingsNode() { return m_pNodeSettings->GetRootNode(); }
...
private:
    ...
    CXMLFile* m_pNodeSettings = nullptr;            // Settings XML node, read from meta.xml and copied into it's own instance
