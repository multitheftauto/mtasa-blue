...
public:
    ...
    void* CreateCustomWaterCannon() override;
    void  DestroyCustomWaterCannon(void* pCannon) override;
    void  UpdateCustomWaterCannon(void* pCannon, const CVector& vecStart, const CVector& vecVelocity) override;
    void  SetCustomWaterCannonColor(void* pCannon, unsigned char ucRed, unsigned char ucGreen, unsigned char ucBlue, unsigned char ucAlpha) override;
    void  ResetCustomWaterCannonColor(void* pCannon) override;
