...
CServerBrowser::CServerBrowser()
{
    ...
    CVector2D resolution = CVector2D(1920, 1080); //CCore::GetSingleton().GetGUI()->GetResolution(); /* TODO AFTER CEGUI API REWRITE */
...
{
    //return m_pTopWindow && m_pTopWindow->IsVisible(); /* TODO AFTER CEGUI API REWRITE */
    return false;
}
...
//
//        // Colours
//        SColor color = SColorRGBA(66, 66, 66, 255);
//
//#if MTA_DEBUG
...
{
    //return (m_pFrame && m_pFrame->IsActive()) || (m_pPanel && m_pPanel->IsActive()); /* TODO AFTER CEGUI API REWRITE */
    return false;
}
