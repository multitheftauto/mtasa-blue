...
void CPrimitiveMaterialBatcher::DrawPrimitive (D3DPRIMITIVETYPE eType, size_t iCollectionSize, const void* pDataAddr, size_t iVertexStride)
{
	int iSize = 1;
	switch (eType) {
		case D3DPT_LINELIST:
	...
	m_pDevice->DrawPrimitiveUP (eType, iSize, pDataAddr, iVertexStride);
}
////////////////////////////////////////////////////////////////
//
