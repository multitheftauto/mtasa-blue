...
CAsset3DBatcher::CAsset3DBatcher(bool bPreGUI, CGraphics* pGraphics)
...
void CAsset3DBatcher::AddPrimitive(D3DPRIMITIVETYPE eType, CMaterialItem* pMaterial, std::vector<PrimitiveMaterialVertice>* pVecVertices)
{
    if (!pMaterial)
        return;
