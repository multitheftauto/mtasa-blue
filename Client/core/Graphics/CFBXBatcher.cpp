...
void CFBXBatcher::Flush()
{
    ...
    g_pCore->GetGame()->GetFBXManager()->Render();
...
////////////////////////////////////////////////////////////////
//
// CFBXBatcher::ClearQueue
//
// Clears all primitives in current queue
//
////////////////////////////////////////////////////////////////
void CFBXBatcher::ClearQueue()
{
    // Clean up
    //for(auto& primitive : m_primitiveList){
...
////////////////////////////////////////////////////////////////
//
// CFBXBatcher::AddTriangle
//
// Add a new primitive to the list
//
//////////////////////////////////////////////////////////////////
//void CFBXBatcher::AddPrimitive(D3DPRIMITIVETYPE eType, std::vector<PrimitiveVertice>* pVecVertices)
//{
