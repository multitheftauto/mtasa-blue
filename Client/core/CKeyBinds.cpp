...
const SBindableKey g_bkKeys[] = {{"mouse1", VK_LBUTTON, GTA_KEY_LMOUSE, DATA_NONE, 0},
                                 ...
                                 // See: https://github.com/multitheftauto/mtasa-blue/issues/367
                                 {"0", '0', GTA_KEY_0, DATA_NONE, 0},
                                 {"1", '1', GTA_KEY_1, DATA_NONE, 0},            // 30
                                 {"2", '2', GTA_KEY_2, DATA_NONE, 0},
                                 {"3", '3', GTA_KEY_3, DATA_NONE, 0},
                                 {"4", '4', GTA_KEY_4, DATA_NONE, 0},
                                 {"5", '5', GTA_KEY_5, DATA_NONE, 0},
                                 {"6", '6', GTA_KEY_6, DATA_NONE, 0},
                                 {"7", '7', GTA_KEY_7, DATA_NONE, 0},
                                 {"8", '8', GTA_KEY_8, DATA_NONE, 0},
                                 {"9", '9', GTA_KEY_9, DATA_NONE, 0},

                                 // VK_A - VK_Z are the same as ASCII 'A' - 'Z' (0x41 - 0x5A)
                                 // See: https://github.com/multitheftauto/mtasa-blue/issues/367
                                 {"a", 'a', GTA_KEY_A, DATA_NONE, 0},
                                 {"b", 'b', GTA_KEY_B, DATA_NONE, 0},            // 40
                                 {"c", 'c', GTA_KEY_C, DATA_NONE, 0},
                                 {"d", 'd', GTA_KEY_D, DATA_NONE, 0},
                                 {"e", 'e', GTA_KEY_E, DATA_NONE, 0},
                                 {"f", 'f', GTA_KEY_F, DATA_NONE, 0},
                                 {"g", 'g', GTA_KEY_G, DATA_NONE, 0},
                                 {"h", 'h', GTA_KEY_H, DATA_NONE, 0},
                                 {"i", 'i', GTA_KEY_I, DATA_NONE, 0},
                                 {"j", 'j', GTA_KEY_J, DATA_NONE, 0},
                                 {"k", 'k', GTA_KEY_K, DATA_NONE, 0},
                                 {"l", 'l', GTA_KEY_L, DATA_NONE, 0},            // 50
                                 {"m", 'm', GTA_KEY_M, DATA_NONE, 0},
                                 {"n", 'n', GTA_KEY_N, DATA_NONE, 0},
                                 {"o", 'o', GTA_KEY_O, DATA_NONE, 0},
                                 {"p", 'p', GTA_KEY_P, DATA_NONE, 0},
                                 {"q", 'q', GTA_KEY_Q, DATA_NONE, 0},
                                 {"r", 'r', GTA_KEY_R, DATA_NONE, 0},
                                 {"s", 's', GTA_KEY_S, DATA_NONE, 0},
                                 {"t", 't', GTA_KEY_T, DATA_NONE, 0},
                                 {"u", 'u', GTA_KEY_U, DATA_NONE, 0},
                                 {"v", 'v', GTA_KEY_V, DATA_NONE, 0},            // 60
                                 {"w", 'w', GTA_KEY_W, DATA_NONE, 0},
                                 {"x", 'x', GTA_KEY_X, DATA_NONE, 0},
                                 {"y", 'y', GTA_KEY_Y, DATA_NONE, 0},
                                 {"z", 'z', GTA_KEY_Z, DATA_NONE, 0},
                                 ...
                                 //{ "F8",    VK_F8,          GTA_KEY_F8,             DATA_NONE },  * Used for console
                                 ...
                                 {";", VK_OEM_1, GTA_KEY_SEMICOLON, DATA_NONE, 0},
                                 {"=", VK_OEM_PLUS, GTA_KEY_EQUALS, DATA_NONE, 0},
                                 {",", VK_OEM_COMMA, GTA_KEY_COMMA, DATA_NONE, 0},
                                 {"-", VK_OEM_MINUS, GTA_KEY_MINUS, DATA_NONE, 0},
                                 {".", VK_OEM_PERIOD, GTA_KEY_PERIOD, DATA_NONE, 0},
                                 {"/", VK_OEM_2, GTA_KEY_SLASH, DATA_NONE, 0},
                                 {"'", VK_OEM_3, GTA_KEY_APOSTROPHE, DATA_NONE, 0},
                                 {"[", VK_OEM_4, GTA_KEY_LBRACKET, DATA_NONE, 0},            // 100
                                 {"\\", VK_OEM_5, GTA_KEY_BACKSLASH, DATA_NONE, 0},
                                 {"]", VK_OEM_6, GTA_KEY_RBRACKET, DATA_NONE, 0},
                                 {"#", VK_OEM_7, GTA_KEY_HASH, DATA_NONE, 0},
