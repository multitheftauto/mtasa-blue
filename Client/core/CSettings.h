...
public:
   ...
   // void SetVisible(bool bVisible); /* TODO AFTER CEGUI API REWRITE */
    bool IsVisible();
    ...
    void UpdateVideoTab();
    //void PopulateResolutionComboBox(); /* TODO AFTER CEGUI API REWRITE */
...
private:
    ...
    //void   CreateChatColorTab(eChatColorType eType, const char* szName, CGUITabPanel* pParent); /* TODO AFTER CEGUI API REWRITE */
    ...
    //CGUIListItem* m_pSelectedBind; /* TODO AFTER CEGUI API REWRITE */
