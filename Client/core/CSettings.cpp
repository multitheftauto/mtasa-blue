...
CSettings::CSettings()
{
    ...
    //m_pWindow = NULL; /* TODO AFTER CEGUI API REWRITE */
    ...
    {
        //SetApplicationSettingInt(GENERAL_PROGRESS_ANIMATION_DISABLE, 0); /* TODO AFTER CEGUI API REWRITE */
...
//    {
//        m_bCaptureAxis = true;
//        //CCore::GetSingleton().ShowMessageBox(_("Binding axis"), _("Move an axis to bind, or escape to clear"), MB_ICON_QUESTION); /* TODO AFTER CEGUI API REWRITE */
//    }
//
//    return true;
//}
...
//                //CCore::GetSingleton().ShowMessageBox(_("Binding a primary key"), strText, MB_ICON_QUESTION); /* TODO AFTER CEGUI API REWRITE */
//            }
//            else
//            {
//                // Create a messagebox to notify the user
...
//                SString strText = _("Press a key to bind, or escape to clear");
//                // CCore::GetSingleton().ShowMessageBox(_("Binding a secondary key"), strText, MB_ICON_QUESTION); /* TODO AFTER CEGUI API REWRITE */
//            }
//        }
//    }
//
...
bool CSettings::ProcessMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    if (m_bCaptureKey)
    {
        ...
        {
            //m_pSelectedBind->SetText(CORE_SETTINGS_NO_KEY); /* TODO AFTER CEGUI API REWRITE */
        }
        else if (pKey)
        {
            //m_pSelectedBind->SetText(pKey->szKey); /* TODO AFTER CEGUI API REWRITE */
        }
        else
        {
            return false;
        ...
        //m_pBindsList->Activate(); /* TODO AFTER CEGUI API REWRITE */
...
//    {
//        //CCore::GetSingleton().ShowMessageBox(_("Error"), _("Your nickname contains invalid characters!"), MB_BUTTON_OK | MB_ICON_INFO); /* TODO AFTER CEGUI API REWRITE */
//        return true;
//    }
//
//    // Save the config
...
//        m_pInterfaceLanguageSelector->SetSelectedItemByIndex(uiIndex);
//
//        //g_pCore->ShowMessageBox(_("Error") + _E("CC82"), _("Please disconnect before changing language"), MB_BUTTON_OK | MB_ICON_INFO); /* TODO AFTER CEGUI API REWRITE */
...
//        //g_pCore->ShowMessageBox(_("Error") + _E("CC80"), _("Please disconnect before changing skin"), MB_BUTTON_OK | MB_ICON_INFO); /* TODO AFTER CEGUI API REWRITE */
//        m_pWindow->MoveToBack();
//        return true;
//    }
//
...
//        //CCore::GetSingleton().ShowMessageBox(_("SCREEN UPLOAD INFORMATION"), strMessage, MB_BUTTON_OK | MB_ICON_INFO); /* TODO AFTER CEGUI API REWRITE */
//    }
//    return true;
//}
//
...
//        //CCore::GetSingleton().ShowMessageBox(_("EXTERNAL SOUNDS"), strMessage, MB_BUTTON_OK | MB_ICON_INFO); /* TODO AFTER CEGUI API REWRITE */
//    }
//    return true;
//}
...
{
    //return m_pWindow->IsActive(); /* TODO AFTER CEGUI API REWRITE */
    return false;
}
