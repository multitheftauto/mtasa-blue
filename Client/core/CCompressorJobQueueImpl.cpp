...
#include "CCompressorJobQueueImpl.h"
...
CCompressorJobQueueImpl::CCompressorJobQueueImpl(void) :
    m_ServiceThreadHandle(CCompressorJobQueueImpl::StaticThreadProc, this)
{
}
...
again:
    ...
    for (auto& pJobData : shared.m_ResultQueue)
    {
