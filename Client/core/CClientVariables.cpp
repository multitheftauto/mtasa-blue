...
{
    std::uint32_t uiViewportWidth = CCore::GetSingleton().GetGraphics()->GetViewportWidth();
    std::uint32_t uiViewportHeight = CCore::GetSingleton().GetGraphics()->GetViewportHeight();
