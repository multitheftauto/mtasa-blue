...
#define MTA_DM_BITSTREAM_VERSION        0x069       // (0x000 - 0xfff) Increment when net messages change (post-release). (Changing will also require additional backward compatibility code).
