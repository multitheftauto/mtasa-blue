...
void CLuaMain::InitVM()
{
    ...
    lua_pushobject(m_luaVM, g_pClientGame->GetRootEntity());
    lua_setglobal(m_luaVM, "root");

    lua_pushobject(m_luaVM, m_pResource);
    lua_setglobal(m_luaVM, "resource");

    lua_pushobject(m_luaVM, m_pResource->GetResourceEntity());
    lua_setglobal(m_luaVM, "resourceRoot");

    lua_pushobject(m_luaVM, m_pResource->GetResourceGUIEntity());
    lua_setglobal(m_luaVM, "guiRoot");

    lua_pushobject(m_luaVM, g_pClientGame->GetLocalPlayer());
