...
ADD_ENUM(PHYSICS_SHAPE_CAPSULE, "capsule")
ADD_ENUM(PHYSICS_SHAPE_CONE, "cone")
ADD_ENUM(PHYSICS_SHAPE_CYLINDER, "cylinder")
ADD_ENUM(PHYSICS_SHAPE_HEIGHTFIELD_TERRAIN, "heightfieldterrain")
ADD_ENUM(PHYSICS_SHAPE_COMPOUND, "compound")
ADD_ENUM(PHYSICS_SHAPE_TRIANGLE_MESH, "trianglemesh")
ADD_ENUM(PHYSICS_SHAPE_CONVEX_HULL, "convexhull")
IMPLEMENT_ENUM_END("physics-shape-type")

IMPLEMENT_ENUM_BEGIN(ePhysicsProperty)
ADD_ENUM(PHYSICS_PROPERTY_MASS, "mass")
ADD_ENUM(PHYSICS_PROPERTY_SLEEPING_THRESHOLDS, "sleepingthresholds")
ADD_ENUM(PHYSICS_PROPERTY_SUBSTEPS, "simulationsubsteps")
ADD_ENUM(PHYSICS_PROPERTY_SIMULATION_ENABLED, "simulationenabled")
ADD_ENUM(PHYSICS_PROPERTY_RESTITUTION, "restitution")
ADD_ENUM(PHYSICS_PROPERTY_SCALE, "scale")
ADD_ENUM(PHYSICS_PROPERTY_DEBUG_COLOR, "debugcolor")
...
ADD_ENUM(PHYSICS_PROPERTY_RADIUS, "radius")
ADD_ENUM(PHYSICS_PROPERTY_HEIGHT, "height")
...
ADD_ENUM(PHYSICS_PROPERTY_MOTION_THRESHOLD, "motionthreshold")
ADD_ENUM(PHYSICS_PROPERTY_SWEPT_SPHERE_RADIUS, "sweptsphereradius")
ADD_ENUM(PHYSICS_PROPERTY_PIVOT_A, "pivota")
ADD_ENUM(PHYSICS_PROPERTY_PIVOT_B, "pivotb")
ADD_ENUM(PHYSICS_PROPERTY_LOWER_LIN_LIMIT, "lowerlinlimit")
...
ADD_ENUM(PHYSICS_PROPERTY_BREAKING_IMPULSE_THRESHOLD, "breakingimpulsethreshold")
ADD_ENUM(PHYSICS_PROPERTY_APPLIED_IMPULSE, "appliedimpulse")
ADD_ENUM(PHYSICS_PROPERTY_JOINTS_FEEDBACK, "jointfeedback")
ADD_ENUM(PHYSICS_PROPERTY_CONSTRAINT_BROKEN, "constraintbroken")
ADD_ENUM(PHYSICS_PROPERTY_TRIGGERCOLLISIONEVENTS, "triggercollisionevents")
ADD_ENUM(PHYSICS_PROPERTY_TRIGGERCONSTRAINTEVENTS, "triggerconstraintevents")
ADD_ENUM(PHYSICS_PROPERTY_RIGID_BODY_A, "rigidbodya")
ADD_ENUM(PHYSICS_PROPERTY_RIGID_BODY_B, "rigidbodyb")
ADD_ENUM(PHYSICS_PROPERTY_SLEEP, "sleep")
ADD_ENUM(PHYSICS_PROPERTY_WANTS_SLEEPING, "wantssleeping")
ADD_ENUM(PHYSICS_PROPERTY_IS_COMPOUND, "iscompound")
ADD_ENUM(PHYSICS_PROPERTY_IS_CONCAVE, "iscocave")
ADD_ENUM(PHYSICS_PROPERTY_IS_CONVEX, "isconvex")
ADD_ENUM(PHYSICS_PROPERTY_IS_CONVEX2D, "isconvex2d")
ADD_ENUM(PHYSICS_PROPERTY_IS_INFINITE, "isinfinite")
ADD_ENUM(PHYSICS_PROPERTY_IS_NON_MOVING, "isnonmoving")
ADD_ENUM(PHYSICS_PROPERTY_IS_POLYHEDRAL, "ispolyhedral")
ADD_ENUM(PHYSICS_PROPERTY_IS_SOFT_BODY, "issoftbody")
IMPLEMENT_ENUM_END("physics-shape-property")

IMPLEMENT_ENUM_CLASS_BEGIN(ePhysicsDebugMode)
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_NoDebug, "nodebug")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_DrawWireframe, "drawwireframe")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_DrawAabb, "drawaabb")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_DrawFeaturesText, "drawfeaturestext")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_DrawContactPoints, "drawcontactpoints")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_NoDeactivation, "nodeactivation")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_NoHelpText, "nohelptext")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_DrawText, "drawtext")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_ProfileTimings, "profiletimings")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_EnableSatComparison, "enablesatcomparison")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_DisableBulletLCP, "disablebulletlcp")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_EnableCCD, "enableccd")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_DrawConstraints, "drawconstraints")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_DrawConstraintLimits, "drawconstraintlimits")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_FastWireframe, "fastwireframe")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_DrawNormals, "drawnormals")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_DrawFrames, "drawframes")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_LINE_WIDTH, "linewidth")
ADD_ENUM(ePhysicsDebugMode::PHYSICS_DEBUG_DRAW_DISTANCE, "drawdistance")
...
ADD_ENUM(PHYSICS_CONTRAINT_HIDGE, "hidge")
ADD_ENUM(PHYSICS_CONTRAINT_FIXED, "fixed")
ADD_ENUM(PHYSICS_CONTRAINT_SLIDER, "slider")
IMPLEMENT_ENUM_END("physics-contraint")

IMPLEMENT_ENUM_BEGIN(ePhysicsRayType)
ADD_ENUM(PHYSICS_RAY_IS_CLEAR, "isclear")
ADD_ENUM(PHYSICS_RAY_DEFAULT, "default")
ADD_ENUM(PHYSICS_RAY_MULTIPLE, "multiple")
IMPLEMENT_ENUM_END("physics-ray-type")
