...
ADD_ENUM(ElementType::Enum::CAMERA, "camera")
ADD_ENUM(ElementType::Enum::PROJECTILE, "projectile")
ADD_ENUM(ElementType::Enum::GUI, "gui-element")
ADD_ENUM(ElementType::Enum::DFF, "dff")
ADD_ENUM(ElementType::Enum::TXD, "txd")
ADD_ENUM(ElementType::Enum::COL, "col")
ADD_ENUM(ElementType::Enum::IFP, "ifp")
ADD_ENUM(ElementType::Enum::IMG, "img")
ADD_ENUM(ElementType::Enum::SOUND, "sound")
ADD_ENUM(ElementType::Enum::DXFONT, "dx-font")
ADD_ENUM(ElementType::Enum::GUIFONT, "gui-font")
ADD_ENUM(ElementType::Enum::TEXTURE, "texture")
ADD_ENUM(ElementType::Enum::SHADER, "shader")
ADD_ENUM(ElementType::Enum::EFFECT, "effect")
ADD_ENUM(ElementType::Enum::POINTLIGHTS, "light")
ADD_ENUM(ElementType::Enum::SEARCHLIGHT, "searchlight")
ADD_ENUM(ElementType::Enum::SCREENSOURCE, "screensource")
ADD_ENUM(ElementType::Enum::RENDERTARGET, "rendertarget")
ADD_ENUM(ElementType::Enum::BROWSER, "browser")
ADD_ENUM(ElementType::Enum::VECTORGRAPHIC, "vectorgraphic")
IMPLEMENT_ENUM_END("element-type")

IMPLEMENT_ENUM_CLASS_BEGIN(CompareMethod)
ADD_ENUM(CompareMethod::EQUAL, "==")
ADD_ENUM(CompareMethod::NOT_EQUAL, "~=")
ADD_ENUM(CompareMethod::EQUAL_OR_HIGHER, ">=")
ADD_ENUM(CompareMethod::EQUAL_OR_LOWER, "<=")
ADD_ENUM(CompareMethod::HIGHER, ">")
ADD_ENUM(CompareMethod::LOWER, "<")
IMPLEMENT_ENUM_CLASS_END("compare-method")
...
IMPLEMENT_ENUM_BEGIN(eClientVehicleType)
ADD_ENUM(CLIENTVEHICLE_CAR, "automobile")
ADD_ENUM(CLIENTVEHICLE_MONSTERTRUCK, "monster_truck")
ADD_ENUM(CLIENTVEHICLE_QUADBIKE, "quadbike")
ADD_ENUM(CLIENTVEHICLE_HELI, "helicopter")
ADD_ENUM(CLIENTVEHICLE_PLANE, "plane")
ADD_ENUM(CLIENTVEHICLE_BOAT, "boat")
ADD_ENUM(CLIENTVEHICLE_TRAIN, "train")
ADD_ENUM(CLIENTVEHICLE_BIKE, "bike")
ADD_ENUM(CLIENTVEHICLE_BMX, "bmx")
ADD_ENUM(CLIENTVEHICLE_TRAILER, "trailer")
IMPLEMENT_ENUM_END("vehicle-type")

IMPLEMENT_ENUM_BEGIN(MarkerType3D::Enum)
ADD_ENUM(MarkerType3D::CHECKPOINT, "checkpoint")
ADD_ENUM(MarkerType3D::CYLINDER, "cylinder")
ADD_ENUM(MarkerType3D::ARROW, "arrow")
ADD_ENUM(MarkerType3D::RING, "ring")
ADD_ENUM(MarkerType3D::CORONA, "corona")
IMPLEMENT_ENUM_END("marker-type")
