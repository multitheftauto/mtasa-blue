...
ADD_ENUM(SURFACE_PROPERTY_STEPEFFECT, "stepeffect")
...
ADD_ENUM(SURFACE_PROPERTY_SKIDMARKTYPE, "skidmakrtype")
ADD_ENUM(SURFACE_PROPERTY_TYREGRIP, "tyregrip")
ADD_ENUM(SURFACE_PROPERTY_WETMULTIPLIER, "wetmultiplier")
...
ADD_ENUM(SURFACE_AUDIO_LONGGRASS, "longgrass")
ADD_ENUM(SURFACE_AUDIO_DISABLED, "disabled")
...
//ADD_ENUM(SURFACE_WHEEL_EFFECT_SPRAY, "spray") -- crash
IMPLEMENT_ENUM_END("surface-wheel-effect")

IMPLEMENT_ENUM_BEGIN(eSurfaceStepEffect)
ADD_ENUM(SURFACE_STEP_EFFECT_SAND, "sand")
ADD_ENUM(SURFACE_STEP_EFFECT_WATER, "water")
ADD_ENUM(SURFACE_STEP_EFFECT_DISABLED, "disabled")
IMPLEMENT_ENUM_END("surface-step-effect")
