...
ADD_ENUM(e2dEffectType::UNKNOWN, "unknown")
ADD_ENUM(e2dEffectType::NONE, "unknown")
...
ADD_ENUM(e2dEffectProperty::OFFSET, "offset")
...
ADD_ENUM(e2dEffectProperty::SIZE, "size")
ADD_ENUM(e2dEffectProperty::ROT, "rotation")
ADD_ENUM(e2dEffectProperty::TEXT_1, "text1")
ADD_ENUM(e2dEffectProperty::TEXT_2, "text2")
ADD_ENUM(e2dEffectProperty::TEXT_3, "text3")
ADD_ENUM(e2dEffectProperty::TEXT_4, "text4")

ADD_ENUM(e2dEffectProperty::BOTTOM, "bottom")
ADD_ENUM(e2dEffectProperty::TOP, "top")
ADD_ENUM(e2dEffectProperty::END, "end")
ADD_ENUM(e2dEffectProperty::DIRECTION, "direction")
IMPLEMENT_ENUM_CLASS_END("2dfx-property-name")

IMPLEMENT_ENUM_CLASS_BEGIN(e2dEffectFlags)
ADD_ENUM(e2dEffectFlags::AT_DAY, "atDay")
ADD_ENUM(e2dEffectFlags::AT_NIGHT, "atNight")
ADD_ENUM(e2dEffectFlags::BLINKING1, "blinking1")
ADD_ENUM(e2dEffectFlags::BLINKING2, "blinking2")
ADD_ENUM(e2dEffectFlags::BLINKING3, "blinking3")
ADD_ENUM(e2dEffectFlags::FOG_TYPE, "fogType")
ADD_ENUM(e2dEffectFlags::FOG_TYPE2, "fogType2")
ADD_ENUM(e2dEffectFlags::CHECK_OBSTACLES, "checkObstacles")
ADD_ENUM(e2dEffectFlags::CHECK_DIRECTION, "checkDirection")
ADD_ENUM(e2dEffectFlags::ONLY_FROM_BELOW, "onlyFromBelow")
ADD_ENUM(e2dEffectFlags::ONLY_LONG_DISTANCE, "onlyLongDistance")
ADD_ENUM(e2dEffectFlags::UPDATE_HEIGHT_ABOVE_GROUND, "updateHeightAboveGround")
ADD_ENUM(e2dEffectFlags::WITHOUT_CORONA, "withoutCorona")

ADD_ENUM(e2dEffectFlags::LINES_NUM, "lines")
ADD_ENUM(e2dEffectFlags::CHARACTERS_PER_LINE, "charactersPerLine")
IMPLEMENT_ENUM_CLASS_END("2dfx-flag-name")
