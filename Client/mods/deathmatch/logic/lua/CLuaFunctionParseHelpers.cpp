...
IMPLEMENT_ENUM_BEGIN(EntityType::Enum)
ADD_ENUM(EntityType::NOTHING, "unknown")
ADD_ENUM(EntityType::BUILDING, "building")
ADD_ENUM(EntityType::VEHICLE, "vehicle")
ADD_ENUM(EntityType::PED, "ped")
ADD_ENUM(EntityType::OBJECT, "object")
ADD_ENUM(EntityType::DUMMY, "dummy")
ADD_ENUM(EntityType::NOTINPOOLS, "unknown")
