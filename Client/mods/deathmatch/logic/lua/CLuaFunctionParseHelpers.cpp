...
IMPLEMENT_ENUM_BEGIN(eVehicleModelDummy::e)
ADD_ENUM(eVehicleModelDummy::e::LIGHT_FRONT_MAIN, "light_front_main")
ADD_ENUM(eVehicleModelDummy::e::LIGHT_REAR_MAIN, "light_rear_main")
ADD_ENUM(eVehicleModelDummy::e::LIGHT_FRONT_SECONDARY, "light_front_second")
ADD_ENUM(eVehicleModelDummy::e::LIGHT_REAR_SECONDARY, "light_rear_second")
ADD_ENUM(eVehicleModelDummy::e::SEAT_FRONT, "seat_front")
ADD_ENUM(eVehicleModelDummy::e::SEAT_REAR, "seat_rear")
ADD_ENUM(eVehicleModelDummy::e::EXHAUST, "exhaust")
ADD_ENUM(eVehicleModelDummy::e::ENGINE, "engine")
ADD_ENUM(eVehicleModelDummy::e::GAS_CAP, "gas_cap")
ADD_ENUM(eVehicleModelDummy::e::TRAILER_ATTACH, "trailer_attach")
ADD_ENUM(eVehicleModelDummy::e::HAND_REST, "hand_rest")
ADD_ENUM(eVehicleModelDummy::e::EXHAUST_SECONDARY, "exhaust_second")
ADD_ENUM(eVehicleModelDummy::e::WING_AIRTRAIL, "wing_airtrail")
ADD_ENUM(eVehicleModelDummy::e::VEH_GUN, "veh_gun")
ADD_ENUM(eVehicleModelDummy::e::VEH_UNKNOWNDUMMY, "veh_unknowndummy")
