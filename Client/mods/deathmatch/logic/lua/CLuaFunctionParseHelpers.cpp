...
ADD_ENUM(eObjectGroup::MASS, "mass")
ADD_ENUM(eObjectGroup::TURNMASS, "turn_mass")
ADD_ENUM(eObjectGroup::AIRRESISTANCE, "air_resistance")
ADD_ENUM(eObjectGroup::ELASTICITY, "elasticity")
ADD_ENUM(eObjectGroup::BUOYANCY, "buoyancy")
ADD_ENUM(eObjectGroup::UPROOTLIMIT, "uproot_limit")
ADD_ENUM(eObjectGroup::COLDAMAGEMULTIPLIER, "col_damage_mult")
ADD_ENUM(eObjectGroup::COLDAMAGEEFFECT, "col_damage_effect")
ADD_ENUM(eObjectGroup::SPECIALCOLRESPONSE, "special_col_response")
ADD_ENUM(eObjectGroup::CAMERAAVOID, "avoid_camera")
ADD_ENUM(eObjectGroup::EXPLOSION, "cause_explosion")
ADD_ENUM(eObjectGroup::FXTYPE, "fx_type")
ADD_ENUM(eObjectGroup::FXOFFSET, "fx_offset")
ADD_ENUM(eObjectGroup::SMASHMULTIPLIER, "smash_multiplier")
ADD_ENUM(eObjectGroup::BREAKVELOCITY, "break_velocity")
ADD_ENUM(eObjectGroup::BREAKVELOCITYRAND, "break_velocity_randomness")
ADD_ENUM(eObjectGroup::BREAKMODE, "break_mode")
ADD_ENUM(eObjectGroup::SPARKSONIMPACT, "sparks_on_impact")
IMPLEMENT_ENUM_END("modelgroup-modifiable")

IMPLEMENT_ENUM_BEGIN(eObjectGroup::DamageEffect)
ADD_ENUM(eObjectGroup::NO_EFFECT, "none")
ADD_ENUM(eObjectGroup::CHANGE_MODEL, "change_model")
ADD_ENUM(eObjectGroup::SMASH_COMPLETELY, "smash")
ADD_ENUM(eObjectGroup::CHANGE_THEN_SMASH, "change_smash")
ADD_ENUM(eObjectGroup::BREAKABLE, "breakable")
ADD_ENUM(eObjectGroup::BREAKABLE_REMOVED, "breakable_remove")
IMPLEMENT_ENUM_END("modelgroup-damageeffect")

IMPLEMENT_ENUM_BEGIN(eObjectGroup::CollisionResponse)
ADD_ENUM(eObjectGroup::NO_RESPONSE, "none")
ADD_ENUM(eObjectGroup::LAMPPOST, "lamppost")
ADD_ENUM(eObjectGroup::SMALLBOX, "small_box")
ADD_ENUM(eObjectGroup::BIGBOX, "big_box")
ADD_ENUM(eObjectGroup::FENCEPART, "fence_part")
ADD_ENUM(eObjectGroup::GRENADE, "grenade")
ADD_ENUM(eObjectGroup::SWINGDOOR, "swingdoor")
ADD_ENUM(eObjectGroup::LOCKDOOR, "lockdoor")
ADD_ENUM(eObjectGroup::HANGING, "hanging")
ADD_ENUM(eObjectGroup::POOLBALL, "poolball")
IMPLEMENT_ENUM_END("modelgroup-collisionresponse")

IMPLEMENT_ENUM_BEGIN(eObjectGroup::FxType)
ADD_ENUM(eObjectGroup::NO_FX, "none")
ADD_ENUM(eObjectGroup::PLAY_ON_HIT, "play_on_hit")
ADD_ENUM(eObjectGroup::PLAY_ON_DESTROYED, "play_on_destroyed")
ADD_ENUM(eObjectGroup::PLAY_ON_HIT_DESTROYED, "play_on_hitdestroyed")
IMPLEMENT_ENUM_END("modelgroup-fxtype")

IMPLEMENT_ENUM_BEGIN(eObjectGroup::BreakMode)
ADD_ENUM(eObjectGroup::NOT_BY_GUN, "not_by_gun")
ADD_ENUM(eObjectGroup::BY_GUN, "by_gun")
ADD_ENUM(eObjectGroup::SMASHABLE, "smashable")
