...
ADD_ENUM(PHYSICS_PROPERTY_VELOCITY, "velocity")
ADD_ENUM(PHYSICS_PROPERTY_ANGULAR_VELOCITY, "angularvelocity")
...
ADD_ENUM(PHYSICS_DEBUG_NoDebug, "nodebug")
ADD_ENUM(PHYSICS_DEBUG_DrawWireframe, "drawwireframe")
ADD_ENUM(PHYSICS_DEBUG_DrawAabb, "drawaabb")
ADD_ENUM(PHYSICS_DEBUG_DrawFeaturesText, "drawfeaturestext")
ADD_ENUM(PHYSICS_DEBUG_DrawContactPoints, "drawcontactpoints")
ADD_ENUM(PHYSICS_DEBUG_NoDeactivation, "nodeactivation")
ADD_ENUM(PHYSICS_DEBUG_NoHelpText, "nohelptext")
ADD_ENUM(PHYSICS_DEBUG_DrawText, "drawtext")
ADD_ENUM(PHYSICS_DEBUG_ProfileTimings, "profiletimings")
ADD_ENUM(PHYSICS_DEBUG_EnableSatComparison, "enablesatcomparison")
ADD_ENUM(PHYSICS_DEBUG_DisableBulletLCP, "disablebulletlcp")
ADD_ENUM(PHYSICS_DEBUG_EnableCCD, "enableccd")
ADD_ENUM(PHYSICS_DEBUG_DrawConstraints, "drawconstraints")
ADD_ENUM(PHYSICS_DEBUG_DrawConstraintLimits, "drawconstraintlimits")
