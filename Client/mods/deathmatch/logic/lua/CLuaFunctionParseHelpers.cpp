...
ADD_ENUM(eShadowType::PLANE, "plane")
ADD_ENUM(eShadowType::CAR, "car")
ADD_ENUM(eShadowType::PED, "ped")
ADD_ENUM(eShadowType::HELI, "heli")
ADD_ENUM(eShadowType::BIKE, "bike")
ADD_ENUM(eShadowType::RCBARON, "rcbaron")
ADD_ENUM(eShadowType::EXPLOSION, "explosion")
ADD_ENUM(eShadowType::HEADLIGHT1, "headlight1")
ADD_ENUM(eShadowType::HEADLIGHT2, "headlight2")
ADD_ENUM(eShadowType::BLOOD, "blood")
ADD_ENUM(eShadowType::HEADMAN, "headman")
ADD_ENUM(eShadowType::WINCRACK, "wincrack")
ADD_ENUM(eShadowType::LAMP, "lamp")
