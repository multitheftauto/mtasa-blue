...
ADD_ENUM(eVehicleDummy::e::LIGHT_FRONT_MAIN, "light_front_main")
ADD_ENUM(eVehicleDummy::e::LIGHT_REAR_MAIN, "light_rear_main")
ADD_ENUM(eVehicleDummy::e::LIGHT_FRONT_SECONDARY, "light_front_second")
ADD_ENUM(eVehicleDummy::e::LIGHT_REAR_SECONDARY, "light_rear_second")
ADD_ENUM(eVehicleDummy::e::SEAT_FRONT, "seat_front")
ADD_ENUM(eVehicleDummy::e::SEAT_REAR, "seat_rear")
ADD_ENUM(eVehicleDummy::e::EXHAUST, "exhaust")
ADD_ENUM(eVehicleDummy::e::ENGINE, "engine")
ADD_ENUM(eVehicleDummy::e::GAS_CAP, "gas_cap")
ADD_ENUM(eVehicleDummy::e::TRAILER_ATTACH, "trailer_attach")
ADD_ENUM(eVehicleDummy::e::HAND_REST, "hand_rest")
ADD_ENUM(eVehicleDummy::e::EXHAUST_SECONDARY, "exhaust_second")
ADD_ENUM(eVehicleDummy::e::WING_AIRTRAIL, "wing_airtrail")
ADD_ENUM(eVehicleDummy::e::VEH_GUN, "veh_gun")
ADD_ENUM(eVehicleDummy::e::VEH_UNKNOWNDUMMY, "veh_unknowndummy")
