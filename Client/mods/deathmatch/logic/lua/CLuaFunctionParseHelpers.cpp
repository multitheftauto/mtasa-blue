...
IMPLEMENT_ENUM_BEGIN(eModelGroup::Modifiable)
ADD_ENUM(eModelGroup::MASS, "mass")
ADD_ENUM(eModelGroup::TURNMASS, "turn_mass")
ADD_ENUM(eModelGroup::AIRRESISTANCE, "air_resistance")
ADD_ENUM(eModelGroup::ELASTICITY, "elasticity")
ADD_ENUM(eModelGroup::BUOYANCY, "buoyancy")
ADD_ENUM(eModelGroup::UPROOTLIMIT, "uproot_limit")
ADD_ENUM(eModelGroup::COLDAMAGEMULTIPLIER, "col_damage_mult")
ADD_ENUM(eModelGroup::COLDAMAGEEFFECT, "col_damage_effect")
ADD_ENUM(eModelGroup::SPECIALCOLRESPONSE, "special_col_response")
ADD_ENUM(eModelGroup::CAMERAAVOID, "avoid_camera")
ADD_ENUM(eModelGroup::EXPLOSION, "cause_explosion")
ADD_ENUM(eModelGroup::FXTYPE, "fx_type")
ADD_ENUM(eModelGroup::FXOFFSET, "fx_offset")
ADD_ENUM(eModelGroup::SMASHMULTIPLIER, "smash_multiplier")
ADD_ENUM(eModelGroup::BREAKVELOCITY, "break_velocity")
ADD_ENUM(eModelGroup::BREAKVELOCITYRAND, "break_velocity_randomness")
ADD_ENUM(eModelGroup::BREAKMODE, "break_mode")
ADD_ENUM(eModelGroup::SPARKSONIMPACT, "sparks_on_impact")
IMPLEMENT_ENUM_END("modelgroup-modifiable")

IMPLEMENT_ENUM_BEGIN(eModelGroup::DamageEffect)
ADD_ENUM(eModelGroup::NO_EFFECT, "none")
ADD_ENUM(eModelGroup::CHANGE_MODEL, "change_model")
ADD_ENUM(eModelGroup::SMASH_COMPLETELY, "smash")
ADD_ENUM(eModelGroup::CHANGE_THEN_SMASH, "change_smash")
ADD_ENUM(eModelGroup::BREAKABLE, "breakable")
ADD_ENUM(eModelGroup::BREAKABLE_REMOVED, "breakable_remove")
IMPLEMENT_ENUM_END("modelgroup-damageeffect")

IMPLEMENT_ENUM_BEGIN(eModelGroup::CollisionResponse)
ADD_ENUM(eModelGroup::NO_RESPONSE, "none")
ADD_ENUM(eModelGroup::LAMPPOST, "lamppost")
ADD_ENUM(eModelGroup::SMALLBOX, "small_box")
ADD_ENUM(eModelGroup::BIGBOX, "big_box")
ADD_ENUM(eModelGroup::FENCEPART, "fence_part")
ADD_ENUM(eModelGroup::GRENADE, "grenade")
ADD_ENUM(eModelGroup::SWINGDOOR, "swingdoor")
ADD_ENUM(eModelGroup::LOCKDOOR, "lockdoor")
ADD_ENUM(eModelGroup::HANGING, "hanging")
ADD_ENUM(eModelGroup::POOLBALL, "poolball")
IMPLEMENT_ENUM_END("modelgroup-collisionresponse")

IMPLEMENT_ENUM_BEGIN(eModelGroup::FxType)
ADD_ENUM(eModelGroup::NO_FX, "none")
ADD_ENUM(eModelGroup::PLAY_ON_HIT, "play_on_hit")
ADD_ENUM(eModelGroup::PLAY_ON_DESTROYED, "play_on_destroyed")
ADD_ENUM(eModelGroup::PLAY_ON_HIT_DESTROYED, "play_on_hitdestroyed")
IMPLEMENT_ENUM_END("modelgroup-fxtype")

IMPLEMENT_ENUM_BEGIN(eModelGroup::BreakMode)
ADD_ENUM(eModelGroup::NOT_BY_GUN, "not_by_gun")
ADD_ENUM(eModelGroup::BY_GUN, "by_gun")
ADD_ENUM(eModelGroup::SMASHABLE, "smashable")
IMPLEMENT_ENUM_END("modelgroup-breakmode")
