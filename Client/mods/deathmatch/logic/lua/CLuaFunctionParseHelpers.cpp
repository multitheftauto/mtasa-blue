...
IMPLEMENT_ENUM_BEGIN(eObjectGroupDynamicProperty)
ADD_ENUM(MASS, "mass")
ADD_ENUM(TURNMASS, "turn_mass")
ADD_ENUM(AIRRESISTANCE, "air_resistance")
ADD_ENUM(ELASTICITY, "elasticity")
ADD_ENUM(BUOYANCY, "buoyancy")
ADD_ENUM(UPROOTLIMIT, "uproot_limit")
ADD_ENUM(COLDAMAGEMULTIPLIER, "col_damage_mult")
ADD_ENUM(COLDAMAGEEFFECT, "col_damage_effect")
ADD_ENUM(SPECIALCOLRESPONSE, "special_col_response")
ADD_ENUM(CAMERAAVOID, "avoid_camera")
ADD_ENUM(EXPLOSION, "cause_explosion")
ADD_ENUM(FXTYPE, "fx_type")
ADD_ENUM(SMASHMULTIPLIER, "smash_multiplier")
ADD_ENUM(BREAKVELOCITY, "break_velocity")
ADD_ENUM(BREAKVELOCITYRAND, "break_velocity_randomness")
ADD_ENUM(BREAKMODE, "break_mode")
ADD_ENUM(SPARKSONIMPACT, "sparks_on_impact")
IMPLEMENT_ENUM_END("objectgroup-dynamic-property")

IMPLEMENT_ENUM_BEGIN(eDynamicObjectDamageEffect)
ADD_ENUM(NONE, "none")
ADD_ENUM(CHANGE_MODEL, "change_model")
ADD_ENUM(SMASH_COMPLETELY, "smash")
ADD_ENUM(CHANGE_THEN_SMASH, "change_smash")
ADD_ENUM(BREAKABLE, "breakable")
ADD_ENUM(BREAKABLE_REMOVED, "breakable_remove")
IMPLEMENT_ENUM_END("objectgroup-property-damageeffect")

IMPLEMENT_ENUM_BEGIN(eDynamicObjectCollisionResponse)
ADD_ENUM(NONE, "none")
ADD_ENUM(LAMPPOST, "lamppost")
ADD_ENUM(SMALLBOX, "small_box")
ADD_ENUM(BIGBOX, "big_box")
ADD_ENUM(FENCEPART, "fence_part")
ADD_ENUM(GRENADE, "grenade")
ADD_ENUM(SWINGDOOR, "swingdoor")
ADD_ENUM(LOCKDOOR, "lockdoor")
ADD_ENUM(HANGING, "hanging")
ADD_ENUM(POOLBALL, "poolball")
IMPLEMENT_ENUM_END("objectgroup-property-colissionresponse")

IMPLEMENT_ENUM_BEGIN(eDynamicPropertyFxType)
ADD_ENUM(NONE, "none")
ADD_ENUM(PLAY_ON_HIT, "play_on_hit")
ADD_ENUM(PLAY_ON_DESTROYED, "play_on_destroyed")
ADD_ENUM(PLAY_ON_HIT_DESTROYED, "play_on_hitdestroyed")
IMPLEMENT_ENUM_END("objectgroup-property-fxtype")

IMPLEMENT_ENUM_BEGIN(eDynamicPropertyBreakMode)
ADD_ENUM(NOT_BY_GUN, "not_by_gun")
ADD_ENUM(BY_GUN, "by_gun")
ADD_ENUM(SMASHABLE, "smashable")
IMPLEMENT_ENUM_END("objectgroup-property-breakmode")
