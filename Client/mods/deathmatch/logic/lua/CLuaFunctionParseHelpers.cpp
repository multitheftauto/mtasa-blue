...
ADD_ENUM(FBX_DATA_TYPE_INDEX, "index")
IMPLEMENT_ENUM_END("fbx-data-type")

IMPLEMENT_ENUM_BEGIN(eFBXProperty)
ADD_ENUM(FBX_PROPERTY_AMBIENT, "ambient")
ADD_ENUM(FBX_PROPERTY_LIGHT_DIFFUSE, "lightdiffuse")
ADD_ENUM(FBX_PROPERTY_LIGHT_AMBIENT, "lightambient")
ADD_ENUM(FBX_PROPERTY_LIGHT_SPECULAR, "lightspecular")
IMPLEMENT_ENUM_END("fbx-property")
...
ADD_ENUM(FBX_TEMPLATE_PROPERTY_DRAW_DISTANCE, "drawdistance")
ADD_ENUM(FBX_TEMPLATE_PROPERTY_VISIBLE_IN_ALL_INTERIORS, "visibleinallinteriors")
ADD_ENUM(FBX_TEMPLATE_PROPERTY_VISIBLE_IN_ALL_DIMENSIONS, "visibleinalldimensions")
ADD_ENUM(FBX_TEMPLATE_PROPERTY_INTERIORS, "interiors")
ADD_ENUM(FBX_TEMPLATE_PROPERTY_DIMENSIONS, "dimensions")
...
ADD_ENUM(FBX_TEMPLATE_MODEL_PROPERTY_DRAW_DISTANCE, "drawdistance")
ADD_ENUM(FBX_TEMPLATE_MODEL_PROPERTY_CULL_MODE, "cullmode")
ADD_ENUM(FBX_TEMPLATE_MODEL_PROPERTY_USE_CUSTOM_OPACITY, "usecustomopacity")
ADD_ENUM(FBX_TEMPLATE_MODEL_PROPERTY_OPACITY, "opacity")
ADD_ENUM(FBX_TEMPLATE_MODEL_PROPERTY_FADE_DISTANCE, "fadedistance")
IMPLEMENT_ENUM_END("fbx-template-model-property")

IMPLEMENT_ENUM_BEGIN(eFBXObjectProperty)
ADD_ENUM(FBX_OBJECT_PROPERTY_TYPE, "type")
ADD_ENUM(FBX_OBJECT_PROPERTY_PARENT, "parent")
ADD_ENUM(FBX_OBJECT_PROPERTY_COLOR_COUNT, "colorcount")
ADD_ENUM(FBX_OBJECT_PROPERTY_INDEX_COUNT, "indexcount")
ADD_ENUM(FBX_OBJECT_PROPERTY_MATERIAL_FACE_ID_COUNT, "materialfaceidcount")
ADD_ENUM(FBX_OBJECT_PROPERTY_NORMAL_COUNT, "normalcount")
ADD_ENUM(FBX_OBJECT_PROPERTY_VERTEX_COUNT, "vertexcount")
ADD_ENUM(FBX_OBJECT_PROPERTY_UV_COUNT, "uvcount")
ADD_ENUM(FBX_OBJECT_PROPERTY_BOUNDING_BOX, "boundingbox")
ADD_ENUM(FBX_OBJECT_PROPERTY_DIFFUSE_COLOR, "diffusecolor")
ADD_ENUM(FBX_OBJECT_PROPERTY_SPECULAR_COLOR, "specularcolor")
ADD_ENUM(FBX_OBJECT_PROPERTY_DIFFUSE_TEXTURE, "diffusetexture")
ADD_ENUM(FBX_OBJECT_PROPERTY_SPECULAR_TEXTURE, "speculartexture")
ADD_ENUM(FBX_OBJECT_PROPERTY_NORMAL_TEXTURE, "normaltexture")
ADD_ENUM(FBX_OBJECT_PROPERTY_GEOMETRY, "geometry")
ADD_ENUM(FBX_OBJECT_PROPERTY_MATERIALS, "materials")
ADD_ENUM(FBX_OBJECT_PROPERTY_POSITION, "position")
ADD_ENUM(FBX_OBJECT_PROPERTY_ROTATION, "rotation")
ADD_ENUM(FBX_OBJECT_PROPERTY_SCALE, "scale")
ADD_ENUM(FBX_OBJECT_PROPERTY_LOCAL_POSITION, "localposition")
ADD_ENUM(FBX_OBJECT_PROPERTY_LOCAL_ROTATION, "localrotation")
ADD_ENUM(FBX_OBJECT_PROPERTY_LOCAL_SCALE, "localscale")
ADD_ENUM(FBX_OBJECT_PROPERTY_TEXTURE, "texture")
ADD_ENUM(FBX_OBJECT_PROPERTY_NAME, "name")
ADD_ENUM(FBX_OBJECT_PROPERTY_TEXTURE_PATH, "texturepath")
IMPLEMENT_ENUM_END("fbx-object-property")

IMPLEMENT_ENUM_BEGIN(eCullMode)
ADD_ENUM(CULL_INSIDE, "inside")
ADD_ENUM(CULL_OUTSIDE, "outside")
