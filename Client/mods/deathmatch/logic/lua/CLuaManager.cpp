...
void CLuaManager::LoadCFunctions(void)
{
    std::map<const char*, lua_CFunction> functions{
        ...
        {"getTimeCycle", CLuaFunctionDefs::GetTimeCycle},
        {"getOriginalTimeCycle", CLuaFunctionDefs::GetOriginalTimeCycle},
        ...
        {"addBirds", CLuaFunctionDefs::AddBirds},

        // World reset funcs
        {"removeBirds", CLuaFunctionDefs::RemoveBirds},
        ...
        {"resetTimeCycle", CLuaFunctionDefs::ResetTimeCycle},
