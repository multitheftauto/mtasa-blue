...
enum ePhysicsShapeType
{
    ...
    PHYSICS_SHAPE_HEIGHTFIELD_TERRAIN,
...
enum ePhysicsProperty
{
    ...
    PHYSICS_PROPERTY_VELOCITY,
    PHYSICS_PROPERTY_ANGULAR_VELOCITY,
    PHYSICS_PROPERTY_SLEEPING_THRESHOLDS,
    PHYSICS_PROPERTY_RESTITUTION,
    PHYSICS_PROPERTY_SCALE,
    PHYSICS_PROPERTY_DEBUG_COLOR,
    PHYSICS_PROPERTY_FILTER_MASK,
    PHYSICS_PROPERTY_FILTER_GROUP,
    PHYSICS_PROPERTY_SIZE,
    PHYSICS_PROPERTY_RADIUS,
    PHYSICS_PROPERTY_HEIGHT,
    PHYSICS_PROPERTY_BOUNDING_BOX,
    PHYSICS_PROPERTY_BOUNDING_SPHERE,
    PHYSICS_PROPERTY_GRAVITY,
    PHYSICS_PROPERTY_USE_CONTINOUS,
    PHYSICS_PROPERTY_MOTION_THRESHOLD,
    PHYSICS_PROPERTY_SWEPT_SPHERE_RADIUS,
    PHYSICS_PROPERTY_SLEEP,
    PHYSICS_PROPERTY_WANTS_SLEEPING,
    PHYSICS_PROPERTY_SPEED,
    PHYSICS_PROPERTY_SIMULATION_ENABLED,
    PHYSICS_PROPERTY_SUBSTEPS,
    PHYSICS_PROPERTY_WORLDSIZE,
    PHYSICS_PROPERTY_TRIGGEREVENTS,
    PHYSICS_PROPERTY_TRIGGERCOLLISIONEVENTS,
    PHYSICS_PROPERTY_TRIGGERCONSTRAINTEVENTS,
    ...
    PHYSICS_PROPERTY_LOWER_ANG_LIMIT,
    PHYSICS_PROPERTY_UPPER_ANG_LIMIT,
    PHYSICS_PROPERTY_BREAKING_IMPULSE_THRESHOLD,
    PHYSICS_PROPERTY_APPLIED_IMPULSE,
    PHYSICS_PROPERTY_RIGID_BODY_A,
    PHYSICS_PROPERTY_RIGID_BODY_B,
    PHYSICS_PROPERTY_JOINTS_FEEDBACK,
    PHYSICS_PROPERTY_CONSTRAINT_BROKEN,

    PHYSICS_PROPERTY_IS_COMPOUND,
    PHYSICS_PROPERTY_IS_CONCAVE,
    PHYSICS_PROPERTY_IS_CONVEX,
    PHYSICS_PROPERTY_IS_CONVEX2D,
    PHYSICS_PROPERTY_IS_INFINITE,
    PHYSICS_PROPERTY_IS_NON_MOVING,
    PHYSICS_PROPERTY_IS_POLYHEDRAL,
...
enum ePhysicsConstraint
{
    ...
    PHYSICS_CONTRAINT_FIXED,
    PHYSICS_CONTRAINT_SLIDER,
