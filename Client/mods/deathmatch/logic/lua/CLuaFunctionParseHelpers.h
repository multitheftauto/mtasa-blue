...
enum eFBXProperty
{
    FBX_PROPERTY_AMBIENT,
    FBX_PROPERTY_LIGHT_DIFFUSE,
    FBX_PROPERTY_LIGHT_AMBIENT,
    FBX_PROPERTY_LIGHT_SPECULAR,
};
DECLARE_ENUM(eFBXProperty);
...
enum eFBXTemplateProperty
{
    ...
    FBX_TEMPLATE_PROPERTY_DRAW_DISTANCE,
    FBX_TEMPLATE_PROPERTY_VISIBLE_IN_ALL_INTERIORS,
    FBX_TEMPLATE_PROPERTY_VISIBLE_IN_ALL_DIMENSIONS,
    FBX_TEMPLATE_PROPERTY_INTERIORS,
    FBX_TEMPLATE_PROPERTY_DIMENSIONS,
};
...
enum eFBXTemplateModelProperty
{
    ...
    FBX_TEMPLATE_MODEL_PROPERTY_DRAW_DISTANCE,
    FBX_TEMPLATE_MODEL_PROPERTY_CULL_MODE,
    FBX_TEMPLATE_MODEL_PROPERTY_PARENT,
    FBX_TEMPLATE_MODEL_PROPERTY_LOD,
    FBX_TEMPLATE_MODEL_PROPERTY_USE_CUSTOM_OPACITY,
    FBX_TEMPLATE_MODEL_PROPERTY_OPACITY,
    FBX_TEMPLATE_MODEL_PROPERTY_FADE_DISTANCE,
};
...
enum eFBXObjectProperty
{
    ...
    FBX_OBJECT_PROPERTY_BOUNDING_BOX,
    ...
    FBX_OBJECT_PROPERTY_TEXTURE,
    FBX_OBJECT_PROPERTY_NAME,
    FBX_OBJECT_PROPERTY_TEXTURE_PATH,
};
