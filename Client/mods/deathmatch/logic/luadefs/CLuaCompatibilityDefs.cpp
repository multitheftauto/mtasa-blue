...
void CLuaCompatibilityDefs::LoadFunctions()
{
    ...
    constexpr static const std::pair<const char*, lua_CFunction> functions[]{
        ...
        {"isVehicleOnGround", reinterpret_cast<lua_CFunction>(CLuaElementDefs::IsElementOnGround) },
        {"isPedOnGround", reinterpret_cast<lua_CFunction>(CLuaElementDefs::IsElementOnGround) },
        {"isPlayerOnGround", reinterpret_cast<lua_CFunction>(CLuaElementDefs::IsElementOnGround) },
