...
public:
    ...
    static bool SetElementBoneRotationQuaternion(lua_State* const luaVM, CClientPed* entity, std::uint32_t boneId, float x, float y, float z, float w);
    ...
    static std::variant<bool, CLuaMultiReturn<float, float, float, float>> GetElementBoneRotationQuaternion(lua_State* const luaVM, CClientPed* entity, std::uint32_t boneId);
