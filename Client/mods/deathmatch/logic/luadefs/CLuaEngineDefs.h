...
public:
    ...
    static bool CLuaEngineDefs::EngineGetModelFlag(uint uiModelID, eModelIdeFlags eFlag);
    static bool CLuaEngineDefs::EngineSetModelFlag(uint uiModelID, eModelIdeFlags eFlag, bool state);
