...
public:
    ...
    static std::variant<CClientSound*, bool>                              PlaySFX(lua_State* luaVM, eAudioLookupIndex containerIndex,
                                                                                std::variant<int, eRadioStreamIndex> bankIndex, int iAudioIndex,
                                                                                std::optional<bool> bLoop);
    static std::variant<CClientSound*, bool>                              PlaySFX3D(lua_State* luaVM, eAudioLookupIndex containerIndex,
                                                                                 std::variant<int, eRadioStreamIndex> bankIndex, int iAudioIndex,
                                                                                 CVector vecPosition, std::optional<bool> bLoop);
    ...
    static bool                  SetSoundEffectEnabled(std::variant<CClientSound*, CClientPlayer*> sound, const std::string strEffectName,
    ...
    static bool                                                           SetSoundEffectParameter(std::variant<CClientSound*, CClientPlayer*> sound,
                                                                                                  SoundEffectType::Enum eEffectType, std::string strEffectParameter,
