...
public:
    ...
    static std::variant<CClientTrainTrack*, bool> GetTrainTrack(CClientVehicle* pVehicle);
    ...
    static bool SetTrainTrack(CClientVehicle* pVehicle, CClientTrainTrack* pTrack);
