...
CClientBuilding* CLuaBuildingDefs::CreateBuilding(lua_State* const luaVM, std::uint16_t modelId, CVector pos, std::optional<float> rotX, std::optional<float> rotY, std::optional<float> rotZ, std::optional<std::uint8_t> interior)
{
