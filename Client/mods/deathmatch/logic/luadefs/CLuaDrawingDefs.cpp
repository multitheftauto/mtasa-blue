...
int CLuaDrawingDefs::DxDrawMaterialPrimitive (lua_State* luaVM)
{
    ...
    while (argStream.NextIsTable ())
    {
        ...
        {
        case 4:
            vecVertices.push_back (PrimitiveMaterialVertice{ vecTableContent[0], vecTableContent[1], 0, (DWORD)0xFFFFFFFF, vecTableContent[2],vecTableContent[3] });
            break;
        case 5:
            vecVertices.push_back (PrimitiveMaterialVertice{ vecTableContent[0], vecTableContent[1], 0, static_cast<DWORD>(vecTableContent[2]), vecTableContent[3],vecTableContent[4] });
            break;
        }
    }
