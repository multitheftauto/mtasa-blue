...
void CClientPedManager::RestreamPeds(std::uint16_t usModel)
{
...
void CClientPedManager::RestreamWeapon(std::uint16_t usModel)
{
...
std::uint16_t CClientPedManager::GetWeaponSlotFromModel(DWORD dwModel)
{
    switch (dwModel)
    {
        case 0:
