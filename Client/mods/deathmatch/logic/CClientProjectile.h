...
public:
    ...
    CEntity*          GetGameEntity(void) { return m_pProjectile; }
    const CEntity*    GetGameEntity(void) const { return m_pProjectile; }
    void              Unlink(void);
    ...
    CClientEntity* GetCreator(void) { return m_pCreator; }
    CClientEntity* GetTargetEntity(void) { return m_pTarget; }
    eWeaponType    GetWeaponType(void) { return m_weaponType; }
    CVector*       GetOrigin(void) { return m_pvecOrigin; }
    CVector*       GetTarget(void) { return m_pvecTarget; }
    float          GetForce(void) { return m_fForce; }
    bool           IsLocal(void) { return m_bLocal; }
