...
public:
    ...
    std::uint32_t GetPlayerScriptDebugLevel() const noexcept { return m_scriptDebugLevel; }
    void          SetPlayerScriptDebugLevel(std::uint32_t level) noexcept { m_scriptDebugLevel = level; }
...
private:
    ...
    std::uint32_t   m_scriptDebugLevel;
