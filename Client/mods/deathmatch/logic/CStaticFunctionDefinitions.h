...
public:
    ...
    static CClientVehicle*  GetPedNearestCarEntryPoint(CClientPed& Ped, bool bCheckDriverDoor, bool bCheckPassengersDoors, uint& uiEntryPoint, CVector& vecClosestDoorPosition);
