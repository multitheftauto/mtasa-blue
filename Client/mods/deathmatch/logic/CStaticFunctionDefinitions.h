...
public:
    ...
    static bool OutputChatBox(const char* szText, std::uint8_t ucRed, std::uint8_t ucGreen, std::uint8_t ucBlue, bool bColorCoded);
    ...
    static CClientEntity* GetElementByID(const char* szID, std::uint32_t uiIndex);
    static CClientEntity* GetElementByIndex(const char* szType, std::uint32_t uiIndex);
    static CClientEntity* GetElementChild(CClientEntity& Entity, std::uint32_t uiIndex);
    ...
    static bool           GetElementInterior(CClientEntity& Entity, std::uint8_t& ucInterior);
    ...
    static bool           GetElementAlpha(CClientEntity& Entity, std::uint8_t& ucAlpha);
    ...
    static bool           GetElementModel(CClientEntity& Entity, std::uint16_t& usModel);
    ...
    static bool          SetElementInterior(CClientEntity& Entity, std::uint8_t ucInterior, bool bSetPosition, CVector& vecPosition);
    static bool          SetElementDimension(CClientEntity& Entity, std::uint16_t usDimension);
    ...
    static bool          SetElementAlpha(CClientEntity& Entity, std::uint8_t ucAlpha);
    static bool          SetElementHealth(CClientEntity& Entity, float fHealth);
    static bool          SetElementModel(CClientEntity& Entity, std::uint16_t usModel);
    ...
    // Radio funcs
    static bool SetRadioChannel(std::uint8_t& ucChannel);
    static bool GetRadioChannel(std::uint8_t& ucChannel);
    ...
    static bool           GetPlayerNametagColor(CClientPlayer& Player, std::uint8_t& ucR, std::uint8_t& ucG, std::uint8_t& ucB);
    ...
    static bool SetPlayerNametagColor(CClientEntity& Entity, bool bRemoveOverride, std::uint8_t ucR, std::uint8_t ucG, std::uint8_t ucB);
    ...
    static bool           GetPedTask(CClientPed& Ped, bool bPrimary, std::uint32_t uiTaskType, std::vector<SString>& outTaskHierarchy);
    ...
    static bool           GetPedClothes(CClientPed& Ped, std::uint8_t ucType, SString& strOutTexture, SString& strOutModel);
    ...
    static bool           GetPedFightingStyle(CClientPed& Ped, std::uint8_t& ucStyle);
    static bool           GetPedMoveAnim(CClientPed& Ped, std::uint32_t& iMoveAnim);
    ...
    static bool SetPedMoveAnim(CClientEntity& Entity, std::uint32_t iMoveAnim);
    static bool AddPedClothes(CClientEntity& Entity, const char* szTexture, const char* szModel, std::uint8_t ucType);
    static bool RemovePedClothes(CClientEntity& Entity, std::uint8_t ucType);
    ...
    static bool SetPedFightingStyle(CClientEntity& Entity, std::uint8_t ucStyle);
    ...
    static bool WarpPedIntoVehicle(CClientPed* pPed, CClientVehicle* pVehicle, std::uint32_t uiSeat);
    static bool SetPedOxygenLevel(CClientEntity& Entity, float fOxygen);

    // Extra Clothes functions
    static bool GetBodyPartName(std::uint8_t ucID, SString& strOutName);
    static bool GetClothesByTypeIndex(std::uint8_t ucType, std::uint8_t ucIndex, SString& strOutTexture, SString& strOutModel);
    ...
    static bool GetClothesTypeName(std::uint8_t ucType, SString& strOutName);

    // Vehicle get funcs
    static CClientVehicle* CreateVehicle(CResource& Resource, std::uint16_t usModel, const CVector& vecPosition, const CVector& vecRotation,
                                         const char* szRegPlate = NULL, std::uint8_t ucVariant = 5, std::uint8_t ucVariant2 = 5);
    static bool            GetVehicleModelFromName(const char* szName, std::uint16_t& usModel);
    ...
    static bool            GetVehicleCurrentGear(CClientVehicle& Vehicle, std::uint16_t& currentGear);
    static bool            GetVehicleVariant(CClientVehicle* pVehicle, std::uint8_t& ucVariant, std::uint8_t& ucVariant2);
    ...
    static bool            SetVehicleModelExhaustFumesPosition(std::uint16_t usModel, CVector& vecPosition);
    static bool            GetVehicleModelExhaustFumesPosition(std::uint16_t usModel, CVector& vecPosition);
    static bool            SetVehicleModelDummyPosition(std::uint16_t usModel, eVehicleDummies eDummy, CVector& vecPosition);
    static bool            GetVehicleModelDummyPosition(std::uint16_t usModel, eVehicleDummies eDummy, CVector& vecPosition);
    static bool            GetVehicleModelDummyDefaultPosition(std::uint16_t usModel, eVehicleDummies eDummy, CVector& vecPosition);
    ...
    static bool AddVehicleUpgrade(CClientEntity& Entity, std::uint16_t usUpgrade);
    static bool AddAllVehicleUpgrades(CClientEntity& Entity);
    static bool RemoveVehicleUpgrade(CClientEntity& Entity, std::uint16_t usUpgrade);
    static bool SetVehicleDoorState(CClientEntity& Entity, std::uint8_t ucDoor, std::uint8_t ucState, bool spawnFlyingComponent);
    static bool SetVehicleWheelStates(CClientEntity& Entity, int iFrontLeft, int iRearLeft = -1, int iFrontRight = -1, int iRearRight = -1);
    static bool SetVehicleLightState(CClientEntity& Entity, std::uint8_t ucLight, std::uint8_t ucState);
    static bool SetVehiclePanelState(CClientEntity& Entity, std::uint8_t ucPanel, std::uint8_t ucState);
    static bool SetVehicleOverrideLights(CClientEntity& Entity, std::uint8_t ucLights);
    ...
    static bool SetVehiclePaintjob(CClientEntity& Entity, std::uint8_t ucPaintjob);
    ...
    static bool SetVehicleAdjustableProperty(CClientEntity& Entity, std::uint16_t usAdjustableProperty);
    ...
    // Object get funcs
    static CClientObject* CreateObject(CResource& Resource, std::uint16_t usModelID, const CVector& vecPosition, const CVector& vecRotation, bool bLowLod);
    ...
    static bool SetObjectVisibleInAllDimensions(CClientEntity& Entity, bool bVisible, std::uint16_t usNewDimension = 0);
    ...
    // Pickup set funcs
    static bool SetPickupType(CClientEntity& Entity, std::uint8_t ucType, double dThree, double dFour);

    // Explosion funcs
    static bool CreateExplosion(CVector& vecPosition, std::uint8_t ucType, bool bMakeSound, float fCamShake, bool bDamaging);
    ...
    // Audio funcs
    static bool PlaySoundFrontEnd(std::uint8_t ucSound);
    ...
    // Blip funcs
    static CClientRadarMarker* CreateBlip(CResource& Resource, const CVector& vecPosition, std::uint8_t ucIcon, std::uint8_t ucSize, const SColor color,
                                          short sOrdering, std::uint16_t usVisibleDistance);
    static CClientRadarMarker* CreateBlipAttachedTo(CResource& Resource, CClientEntity& Entity, std::uint8_t ucIcon, std::uint8_t ucSize, const SColor color,
                                                    short sOrdering, std::uint16_t usVisibleDistance);

    static bool SetBlipIcon(CClientEntity& Entity, std::uint8_t ucIcon);
    static bool SetBlipSize(CClientEntity& Entity, std::uint8_t ucSize);
    ...
    static bool SetBlipVisibleDistance(CClientEntity& Entity, std::uint16_t usVisibleDistance);
    ...
    static bool           GetCameraInterior(std::uint8_t& ucInterior);
    ...
    static bool SetCameraInterior(std::uint8_t ucInterior);
    static bool FadeCamera(bool bFadeIn, float fFadeTime, std::uint8_t ucRed, std::uint8_t ucGreen, std::uint8_t ucBlue);
    ...
    static void GUIEditSetMaxLength(CClientEntity& Element, std::uint32_t iLength);
    static void GUIEditSetCaretIndex(CClientEntity& Element, std::uint32_t iCaret);

    static void GUIMemoSetReadOnly(CClientEntity& Element, bool bFlag);
    static void GUIMemoSetCaretIndex(CClientEntity& Element, std::uint32_t iCaret);
    ...
    static inline std::uint32_t GUIGridListAddColumn(CClientGUIElement& GUIElement, const char* szTitle, float fWidth)
    {
        return static_cast<CGUIGridList*>(GUIElement.GetCGUIElement())->AddColumn(szTitle, fWidth);
    };
    static inline void GUIGridListRemoveColumn(CClientGUIElement& GUIElement, std::uint32_t uiColumn)
    {
        static_cast<CGUIGridList*>(GUIElement.GetCGUIElement())->RemoveColumn(uiColumn);
    };
    static inline void GUIGridListSetColumnWidth(CClientGUIElement& GUIElement, std::uint32_t uiColumn, float fWidth, bool bRelative = true)
    {
        static_cast<CGUIGridList*>(GUIElement.GetCGUIElement())->SetColumnWidth(uiColumn, fWidth, bRelative);
    };
    static inline void GUIGridListSetColumnTitle(CClientGUIElement& GUIElement, std::uint32_t uiColumn, const char* szTitle)
    {
    ...
    static inline void GUIGridListAutoSizeColumn(CClientGUIElement& GUIElement, std::uint32_t uiColumn)
    {
    ...
    static void        GUIGridListSetSelectionMode(CClientEntity& Element, std::uint32_t uiMode);
    ...
    // World functions
    static bool GetTime(std::uint8_t& ucHour, std::uint8_t& ucMin);
    ...
    static bool          GetGarageSize(std::uint8_t ucGarageID, float& fHeight, float& fWidth, float& fDepth);
    static bool          GetGarageBoundingBox(std::uint8_t ucGarageID, float& fLeft, float& fRight, float& fFront, float& fBack);
    ...
    static bool          RemoveWorldBuilding(std::uint16_t usModelToRemove, float fDistance, float fX, float fY, float fZ, char cInterior, uint& uiOutAmount);
    static bool          RestoreWorldBuildings(uint& uiOutAmount);
    static bool RestoreWorldBuilding(std::uint16_t usModelToRestore, float fDistance, float fX, float fY, float fZ, char cInterior, uint& uiOutAmount);

    static bool SetTime(std::uint8_t ucHour, std::uint8_t ucMin);
    ...
    static bool SetTrafficLightState(std::uint8_t ucState);
    ...
    static CClientProjectile* CreateProjectile(CResource& Resource, CClientEntity& Creator, std::uint8_t ucWeaponType, CVector& vecOrigin, float fForce,
                                               CClientEntity* pTarget, CVector& vecRotation, CVector& vecVelocity, std::uint16_t usModel = 0);
    ...
    // Weapon funcs
    static bool           GetWeaponNameFromID(std::uint8_t ucID, SString& strOutName);
    ...
    static bool              GetVehicleHandling(CClientVehicle* pVehicle, eHandlingProperty eProperty, std::uint32_t& uiValue);
    static bool              GetVehicleHandling(CClientVehicle* pVehicle, eHandlingProperty eProperty, std::uint8_t& ucValue);
    ...
    static bool              GetEntryHandling(CHandlingEntry* pEntry, eHandlingProperty eProperty, std::uint32_t& uiValue);
    static bool              GetEntryHandling(CHandlingEntry* pEntry, eHandlingProperty eProperty, std::uint8_t& ucValue);
    ...
    static bool              SetVehicleHandling(CClientVehicle* pVehicle, eHandlingProperty eProperty, std::uint32_t uiValue);
    static bool              SetVehicleHandling(CClientVehicle* pVehicle, eHandlingProperty eProperty, std::uint8_t ucValue);
