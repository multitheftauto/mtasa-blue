...
static const SFixedArray<std::uint32_t, 212> g_ulVehicleAttributes = {
...
bool CClientVehicleManager::IsTrainModel(std::uint32_t ulModel)
{
    return (ulModel == 449 || ulModel == 537 || ulModel == 538 || ulModel == 569 || ulModel == 590 || ulModel == 570);
}

bool CClientVehicleManager::IsValidModel(std::uint32_t ulModel)
{
    CModelInfo* pModelInfo = g_pGame->GetModelInfo(ulModel);
    return pModelInfo && pModelInfo->IsVehicle();
}

bool CClientVehicleManager::IsStandardModel(std::uint32_t ulModel)
{
    return ulModel >= 400 && ulModel <= 611;
}

eClientVehicleType CClientVehicleManager::GetVehicleType(std::uint32_t ulModel)
{
    // Valid vehicle id?
...
std::uint8_t CClientVehicleManager::GetMaxPassengerCount(std::uint32_t ulModel)
{
...
std::uint8_t CClientVehicleManager::ConvertIndexToGameSeat(std::uint32_t ulModel, std::uint8_t ucIndex)
{
...
bool CClientVehicleManager::HasDoors(std::uint32_t ulModel)
{
