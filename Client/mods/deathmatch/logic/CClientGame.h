...
private:
    ...
    static void StaticVehicleAddExhaustParticlesHandler(CVehicleSAInterface* pInterface, CVector& leftFumesPosition, CVector& rightFumesPosition,
...
public:
    ...
    void VehicleAddExhaustParticlesHandler(CVehicleSAInterface* pInterface, CVector& leftFumesPosition, CVector& rightFumesPosition, bool& leftFumesVisible,
                                           bool& rightFumesVisible);
