...
bool CClientPad::SetAnalogControlState ( const char * szName, float fState )
{
    ...
    if ( GetAnalogControlIndex ( szName, uiIndex ) )
    {
        switch ( uiIndex )
        {
            ...
            case 1: m_sScriptedStates [ uiIndex ] = ( short ) ( fState * 128.0f ); m_sScriptedStates [ 0 ] = 0; return true;        //Right
            case 2: m_sScriptedStates [ uiIndex ] = ( short ) ( fState * -128.0f ); m_sScriptedStates [ 3 ] = 0; return true;       //Up
            case 3: m_sScriptedStates [ uiIndex ] = ( short ) ( fState * 128.0f ); m_sScriptedStates [ 2 ] = 0; return true;        //Down
            case 4: m_sScriptedStates [ uiIndex ] = ( short ) ( fState * -128.0f ); m_sScriptedStates [ 5 ] = 0; return true;       //Vehicle Left
            case 5: m_sScriptedStates [ uiIndex ] = ( short ) ( fState * 128.0f ); m_sScriptedStates [ 4 ] = 0;  return true;       //Vehicle Right 
            case 6: m_sScriptedStates [ uiIndex ] = ( short ) ( fState * -128.0f ); m_sScriptedStates [ 7 ] = 0; return true;       //Up
            case 7: m_sScriptedStates [ uiIndex ] = ( short ) ( fState * 128.0f ); m_sScriptedStates [ 6 ] = 0; return true;        //Down
            ...
            case 10: m_sScriptedStates [ uiIndex ] = ( short ) ( fState * -128.0f ); m_sScriptedStates [ 11 ] = 0 ; return true;    //Special Left
            case 11: m_sScriptedStates [ uiIndex ] = ( short ) ( fState * 128.0f ); m_sScriptedStates [ 10 ] = 0 ; return true;     //Special Right
            case 12: m_sScriptedStates [ uiIndex ] = ( short ) ( fState * -128.0f ); m_sScriptedStates [ 13 ] = 0 ; return true;    //Special Up
            case 13: m_sScriptedStates [ uiIndex ] = ( short ) ( fState * 128.0f ); m_sScriptedStates [ 12 ] = 0 ; return true;     //Special Down
            default: return false;
        }
    }
