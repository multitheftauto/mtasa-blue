...
void CWebsiteRequests::SetPendingRequests(const std::unordered_set<SString>& pendingRequests, WebRequestCallback* pCallback)
{
    ...
    // Apply text
    //m_pAddressMemo->SetText(content.c_str()); /* TODO AFTER CEGUI API REWRITE */
...
{
    //m_pAddressMemo->SetText(""); /* TODO AFTER CEGUI API REWRITE */
    m_Callbacks.clear();
}
...
/* TODO AFTER CEGUI API REWRITE */
//bool CWebsiteRequests::OnAllowButtonClick()
//{
//    Hide();
...
//}
//
//bool CWebsiteRequests::OnDenyButtonClick()
//{
//    Hide();
