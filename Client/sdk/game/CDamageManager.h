...
public:
    ...
    virtual void          SetPanelStatus(BYTE bPanel, BYTE bPanelStatus, bool spawnFlyingComponent) = 0;
    virtual void          SetPanelStatus(unsigned long ulStatus, bool spawnFlyingComponent) = 0;
