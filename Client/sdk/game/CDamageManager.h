...
enum eSurfaceProperties
{
    ...
    SURFACE_PROPERTY_WETMULTIPLIER,
    SURFACE_PROPERTY_ADHESIONGROUP,
    SURFACE_PROPERTY_WHEELEFFECT,
    SURFACE_PROPERTY_FRACTIONEFFECT,
};

enum eSurfaceStepEffect
{
    SURFACE_STEP_EFFECT_SAND,
    SURFACE_STEP_EFFECT_WATER,
    SURFACE_STEP_EFFECT_DISABLED,
};

enum eSurfaceBulletEffect
{
    SURFACE_BULLET_EFFECT_METAL = 8,
    SURFACE_BULLET_EFFECT_SAND = 9,
    SURFACE_BULLET_EFFECT_CONCRETE = 10,
