...
public:
    ...
    virtual RpClump*         ReadDFF(const SString& strFilename, const SString& buffer, std::uint16_t usModelID, bool bLoadEmbeddedCollisions) = 0;
    ...
    virtual void             ReplaceCollisions(CColModel* pColModel, std::uint16_t usModelID) = 0;
    virtual std::uint32_t     LoadAtomics(RpClump* pClump, RpAtomicContainer* pAtomics) = 0;
    virtual bool             ReplaceAllAtomicsInModel(RpClump* pSrc, std::uint16_t usModelID) = 0;
    virtual void             ReplaceAllAtomicsInClump(RpClump* pDst, RpAtomicContainer* pAtomics, std::uint32_t uiAtomics) = 0;
    virtual void             ReplaceWheels(RpClump* pClump, RpAtomicContainer* pAtomics, std::uint32_t uiAtomics, const char* szWheel) = 0;
    ...
    virtual bool             ReplaceVehicleModel(RpClump* pNew, std::uint16_t usModelID) = 0;
    virtual bool             ReplaceWeaponModel(RpClump* pNew, std::uint16_t usModelID) = 0;
    virtual bool             ReplacePedModel(RpClump* pNew, std::uint16_t usModelID) = 0;
    virtual bool             ReplacePartModels(RpClump* pClump, RpAtomicContainer* pAtomics, std::uint32_t uiAtomics, const char* szName) = 0;
