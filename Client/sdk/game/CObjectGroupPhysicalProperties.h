...
public:
    ...
    virtual void                           SetColissionDamageEffect(eModelGroup::DamageEffect eDamageEffect) = 0;
    virtual eModelGroup::DamageEffect      GetCollisionDamageEffect() = 0;
    virtual void                           SetCollisionSpecialResponseCase(eModelGroup::CollisionResponse eResponseCase) = 0;
    virtual eModelGroup::CollisionResponse GetCollisionSpecialResponseCase() = 0;
    ...
    virtual void                           SetFxType(eModelGroup::FxType eFxType) = 0;
    virtual eModelGroup::FxType            GetFxType() = 0;
    ...
    virtual void                           SetBreakMode(eModelGroup::BreakMode eBreakMode) = 0;
    virtual eModelGroup::BreakMode         GetBreakMode() = 0;
