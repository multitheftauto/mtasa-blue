...
public:
    ...
    virtual PickupType::Enum  GetType() = 0;
    virtual void              SetType(PickupType::Enum type) = 0;
    ...
    virtual PickupState::Enum GetState() = 0;
    virtual void              SetState(PickupState::Enum bState) = 0;
