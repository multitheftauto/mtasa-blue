...
public:
    ...
    virtual bool AddShadow(eShadowType shadowType, const CVector& vecPosition, const CVector2D& vecOffset1, const CVector2D& vecOffset2, SColor color,
                           float fZDistance, bool bDrawOnWater, bool bDrawOnBuildings) = 0;
    virtual bool AddShadow(RwTexture* pRwTexture, uint8_t type, const CVector& vecPosition, const CVector2D& vecOffset1, const CVector2D& vecOffset2, SColor color,
                           float fZDistance, bool bDrawOnWater, bool bDrawOnBuildings) = 0;
