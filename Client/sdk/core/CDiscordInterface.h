...
public:
    ...
    virtual void SetPresenceStartTimestamp(const std::int64_t iStart) = 0;
    virtual void SetPresenceEndTimestamp(const std::int64_t iEnd) = 0;
    ...
    virtual bool SetPresenceButtons(std::uint8_t uiIndex, const char* szName, const char* szUrl) = 0;
