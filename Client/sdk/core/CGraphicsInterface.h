...
public:
    ...
    virtual float GetDXTextSize(const char* szText, float fWidth = 0, float fScaleX = 1.0f, float fScaleY = 1.0f, ID3DXFont* pDXFont = NULL, bool bWordBreak = false, bool bColorCoded = false) = 0;
