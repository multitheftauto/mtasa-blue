...
public:
    ...
    virtual void DrawCircleQueued(float fX, float fY, float fRadius, float startAngle, float stopAngle, unsigned long color, unsigned long colorCenter, ushort fResolution, float fRatio, bool bPostGUI, bool bSubPixelPositioning) = 0;
