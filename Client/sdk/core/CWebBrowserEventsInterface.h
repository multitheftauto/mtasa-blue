...
public:
    ...
    virtual void Events_OnChangeCursor(std::uint8_t ucCursor) = 0;
    ...
    virtual void Events_OnResourceBlocked(const SString& strURL, const SString& strDomain, std::uint8_t reason) = 0;
