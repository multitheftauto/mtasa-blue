...
public:
    ...
    virtual void  SetCustomWaterCannonColor(void* pCannon, unsigned char ucRed, unsigned char ucGreen, unsigned char ucBlue, unsigned char ucAlpha) = 0;
    virtual void  ResetCustomWaterCannonColor(void* pCannon) = 0;
