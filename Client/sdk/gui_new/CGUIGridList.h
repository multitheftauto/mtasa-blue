...
public:
    ...
    virtual int           AddRow(std::vector<std::pair<SString, bool> >* m_items = NULL) = 0;
    ...
    virtual int           SetItemText(int iRow, int hColumn, const char* szText, bool bNumber = false, bool bSection = false) = 0;
