...
// Stale: the train code no longer reads either of these. Both arrays are relocated to ones big
// enough for custom track IDs, so the originals sit empty - go through CTrainTrackManagerSA instead.
