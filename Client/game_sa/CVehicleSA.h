...
public:
    ...
    void SetVehicleWheelRotation(float fWheelRot1, float fWheelRot2, float fWheelRot3, float fWheelRot4);
    void SetBikeWheelRotation(float fWheelRot1, float fWheelRot2);
