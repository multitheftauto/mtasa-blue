...
public:
    ...
    void          SetWorldSoundAudibleRange(CAESound* pAESound, float fAudibleRange, float fMinDistance);
    void          UpdateWorldSoundAudibleRange(uint uiGroup, uint uiIndex, float fAudibleRange, float fMinDistance);
