 ...
 *  FILE:        Client/game_sa/TaskJumpFallSA.h
...
public:
    uchar m_bIsFinished;
    uchar m_bAddedIdleAnim;
    uchar m_bAnimsReferenced;
    uchar m_bAttackButtonPressed;
    uchar m_bSwitchedWeapons;
