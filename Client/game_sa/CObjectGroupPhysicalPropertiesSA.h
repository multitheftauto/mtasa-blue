...
public:
    ...
    eModelGroup::DamageEffect      eColDamageEffect;
    eModelGroup::CollisionResponse eSpecialColResponse;
...
public:
    ...
    void                           SetColissionDamageEffect(eModelGroup::DamageEffect ucDamageEffect);
    eModelGroup::DamageEffect      GetCollisionDamageEffect();
    void                           SetCollisionSpecialResponseCase(eModelGroup::CollisionResponse ucResponseCase);
    eModelGroup::CollisionResponse GetCollisionSpecialResponseCase();
    ...
    void                           SetFxType(eModelGroup::FxType eFxType);
    eModelGroup::FxType            GetFxType();
    ...
    void                           SetBreakMode(eModelGroup::BreakMode eBreakMode);
    eModelGroup::BreakMode         GetBreakMode();
