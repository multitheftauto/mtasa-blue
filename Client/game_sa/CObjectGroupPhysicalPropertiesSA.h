...
public:
    ...
    eDynamicObjectDamageEffect      eColDamageEffect;
    eDynamicObjectCollisionResponse eSpecialColResponse;
...
public:
    ...
    void                            SetColissionDamageEffect(eDynamicObjectDamageEffect ucDamageEffect);
    eDynamicObjectDamageEffect      GetCollisionDamageEffect();
    void                            SetCollisionSpecialResponseCase(eDynamicObjectCollisionResponse ucResponseCase);
    eDynamicObjectCollisionResponse GetCollisionSpecialResponseCase();
    ...
    bool                            SetFxType(eDynamicPropertyFxType eFxType);
    eDynamicPropertyFxType          GetFxType();
    ...
    void                            SetBreakMode(eDynamicPropertyBreakMode eBreakMode);
    eDynamicPropertyBreakMode       GetBreakMode();
