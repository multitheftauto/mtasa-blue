...
public:
    ...
    void SetOffsetPos(const CVector& offset)
    {
        ((void(__thiscall*)(CFxSystemSAInterface*, const CVector&))0x4AA660)(this, offset);
    }

    void SetConstTime(bool enableConstTime, float time)
    {
        ((void(__thiscall*)(CFxSystemSAInterface*, bool, float))0x4AA6C0)(this, enableConstTime, time);
    }
};
