...
{
    VehicleSoundType::Enum m_eVehicleSoundType;
...
public:
    ...
    VehicleSoundType::Enum GetSoundType() const noexcept override { return m_Settings.m_eVehicleSoundType; };
    ...
    void SetSoundType(VehicleSoundType::Enum value) noexcept override { m_Settings.m_eVehicleSoundType = value; };
