...
public:
    ...
    void SetRunningCompressed(bool bCompressed, bool isANPK)
    {
        m_pInterface->bRunningCompressed = bCompressed;
        if (isANPK && !bCompressed)
            m_pInterface->keepCompressed = false;
    }
