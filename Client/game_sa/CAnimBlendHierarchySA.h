...
public:
    ...
    std::uint32_t                   uiHashKey;
    CAnimBlendSequenceSAInterface* pSequences;
    std::uint16_t                 usNumSequences;
...
public:
    ...
    void                            SetNumSequences(std::uint16_t uNumSequences) { m_pInterface->usNumSequences = uNumSequences; }
    ...
    std::uint16_t                  GetNumSequences() { return m_pInterface->usNumSequences; }
    ...
    std::uint32_t                    GetNameHashKey() { return m_pInterface->uiHashKey; }
