...
public:
    void CreateEntityFx(CEntitySAInterface* entity, const char* effectName, CVector* position)
    {
        if (!entity)
            return;
        ...
        ((void(__thiscall*)(CFxSAInterface*, CEntitySAInterface*, const char*, CVector*, RwMatrix*))0x4A11E0)(this, entity, effectName, position, matrixTransform);
    }

    void DestroyEntityFx(CEntitySAInterface* entity)
    {
        ((void(__thiscall*)(CFxSAInterface*, CEntitySAInterface*))0x4A1280)(this, entity);
    }
};

static auto* g_Fx = reinterpret_cast<CFxSAInterface*>(0xA9AE00); // g_Fx
...
public:
    ...
    static std::vector<CEntitySAInterface*> GetEntitiesFromFx(std::uint32_t modelID);
