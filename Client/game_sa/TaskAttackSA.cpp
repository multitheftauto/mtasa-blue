                                                   ...
                                                   char nDrivebyStyle, bool bSeatRHS)
{
    ...
    // clang-format off
    using func_t = void (__thiscall*)(decltype(dwThisInterface), decltype(dwTargetEntity), decltype(pVecTarget), decltype(fAbortRange), decltype(FrequencyPercentage), decltype(nDrivebyStyle), decltype(bSeatRHS));
    reinterpret_cast<func_t>(dwFunc)(dwThisInterface, dwTargetEntity, pVecTarget, fAbortRange, FrequencyPercentage, nDrivebyStyle, bSeatRHS);
    // clang-format on
}
...
CTaskSimpleUseGunSA::CTaskSimpleUseGunSA(CEntity* pTargetEntity, CVector vecTarget, char nCommand, short nBurstLength, unsigned char bAimImmediate)
{
    ...
    // clang-format off
    using func_t = void (__thiscall*)(decltype(dwThisInterface), decltype(dwTargetEntity), decltype(fTargetX), decltype(fTargetY), decltype(fTargetZ), decltype(nCommand), decltype(dwBurstLength), decltype(bAimImmediate));
    reinterpret_cast<func_t>(dwFunc)(dwThisInterface, dwTargetEntity, fTargetX, fTargetY, fTargetZ, nCommand, dwBurstLength, bAimImmediate);
    // clang-format on
}
...
void CTaskSimpleUseGunSA::FireGun(CPed* pPed, bool bFlag)
{
    ...
    // clang-format off
    using func_t = void (__thiscall*)(decltype(dwThisInterface), decltype(dwPedInterface), decltype(bFlag));
    reinterpret_cast<func_t>(dwFunc)(dwThisInterface, dwPedInterface, bFlag);
    // clang-format on
}
...
bool CTaskSimpleUseGunSA::ControlGun(CPed* pPed, CEntity* pTargetEntity, char nCommand)
{
    ...
    DWORD dwTargetEntity = (pTargetEntity) ? (DWORD)pTargetEntity->GetInterface() : 0;
    // clang-format off
    using func_t = decltype(bReturn) (__thiscall*)(decltype(dwThisInterface), decltype(dwPedInterface), decltype(dwTargetEntity), decltype(nCommand));
bReturn =     reinterpret_cast<func_t>(dwFunc)(dwThisInterface, dwPedInterface, dwTargetEntity, nCommand);
    // clang-format on
    return bReturn;
}
...
bool CTaskSimpleUseGunSA::ControlGunMove(CVector2D* pMoveVec)
{
    ...
    DWORD dwThisInterface = (DWORD)GetInterface();
    // clang-format off
    using func_t = decltype(bReturn) (__thiscall*)(decltype(dwThisInterface), decltype(pMoveVec));
bReturn =     reinterpret_cast<func_t>(dwFunc)(dwThisInterface, pMoveVec);
    // clang-format on
    return bReturn;
}
...
void CTaskSimpleUseGunSA::Reset(CPed* pPed, CEntity* pTargetEntity, CVector vecTarget, char nCommand, short nBurstLength)
{
    ...
    DWORD dwBurstLength = nBurstLength;
    // clang-format off
    using func_t = void (__thiscall*)(decltype(dwThisInterface), decltype(dwPedInterface), decltype(dwTargetEntity), decltype(fTargetX), decltype(fTargetY), decltype(fTargetZ), decltype(nCommand), decltype(dwBurstLength));
    reinterpret_cast<func_t>(dwFunc)(dwThisInterface, dwPedInterface, dwTargetEntity, fTargetX, fTargetY, fTargetZ, nCommand, dwBurstLength);
    // clang-format on
}
...
int CTaskSimpleUseGunSA::GetTaskType()
{
    ...
    DWORD dwThisInterface = (DWORD)GetInterface();
    // clang-format off
    using func_t = decltype(iReturn) (__thiscall*)(decltype(dwThisInterface) );
iReturn =     reinterpret_cast<func_t>(dwFunc)(dwThisInterface);
    // clang-format on
    return iReturn;
}
...
void CTaskSimpleUseGunSA::AbortIK(CPed* pPed)
{
    ...
    DWORD dwPedInterface = (DWORD)pPed->GetInterface();
    // clang-format off
    using func_t = void (__thiscall*)(decltype(dwThisInterface), decltype(dwPedInterface));
    reinterpret_cast<func_t>(dwFunc)(dwThisInterface, dwPedInterface);
    // clang-format on
}
...
void CTaskSimpleUseGunSA::RemoveStanceAnims(CPed* pPed, float f)
{
    ...
    DWORD dwPedInterface = (DWORD)pPed->GetInterface();
    // clang-format off
    using func_t = void (__thiscall*)(decltype(dwThisInterface), decltype(dwPedInterface), decltype(f));
    reinterpret_cast<func_t>(dwFunc)(dwThisInterface, dwPedInterface, f);
    // clang-format on
}
...
bool CTaskSimpleUseGunSA::RequirePistolWhip(CPed* pPed, CEntity* pTargetEntity)
{
    ...
    DWORD dwTargetEntity = (pTargetEntity) ? (DWORD)pTargetEntity->GetInterface() : 0;
    // clang-format off
    using func_t = decltype(bReturn) (__cdecl*)(decltype(dwPedInterface), decltype(dwTargetEntity));
bReturn =     reinterpret_cast<func_t>(dwFunc)(dwPedInterface, dwTargetEntity);
    // clang-format on
    return bReturn;
}
...
void CTaskSimpleUseGunSA::SetBurstLength(short a)
{
    ...
    DWORD dwThisInterface = (DWORD)GetInterface();
    // clang-format off
    using func_t = void (__thiscall*)(decltype(dwThisInterface), decltype(a));
    reinterpret_cast<func_t>(dwFunc)(dwThisInterface, a);
    // clang-format on
}
...
void CTaskSimpleUseGunSA::StartCountDown(unsigned char a, bool b)
{
    ...
    DWORD dwThisInterface = (DWORD)GetInterface();
    // clang-format off
    using func_t = void (__thiscall*)(decltype(dwThisInterface), decltype(a), decltype(b));
    reinterpret_cast<func_t>(dwFunc)(dwThisInterface, a, b);
    // clang-format on
}
...
CTaskSimpleFightSA::CTaskSimpleFightSA(CEntity* pTargetEntity, int nCommand, unsigned int nIdlePeriod)
{
    ...
    DWORD dwTargetEntity = (pTargetEntity) ? (DWORD)pTargetEntity->GetInterface() : 0;
    // clang-format off
    using func_t = void (__thiscall*)(decltype(dwThisInterface), decltype(dwTargetEntity), decltype(nCommand), decltype(nIdlePeriod));
    reinterpret_cast<func_t>(dwFunc)(dwThisInterface, dwTargetEntity, nCommand, nIdlePeriod);
    // clang-format on
}
