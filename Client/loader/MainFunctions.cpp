...
void CheckDataFiles()
{
    ...
    struct
    {
        const char* expected;
        const char* fileName;
    } integrityCheckList[] = {{"36CB1B284BC7CBB4F25CD00BBB044550", "bass.dll"},           {"9B4C6A7E9B176BA5FCEB98fA2D1607E2", "bass_aac.dll"},
                              {"E7E69A3B369F0ABA1A4A18C831BC4364", "bass_ac3.dll"},       {"663EBBF55C9D3B41F3732BC0560D84EE", "bass_fx.dll"},
