...
#define QUOTE_DEFINE(x) QUOTE_DEFINE2(x)
    ...
    #define MTA_DM_BUILDTAG_SHORT   QUOTE_DEFINE ( BUILD_NUMBER_FORMAT )
    #define MTA_DM_BUILDTAG_LONG    QUOTE_DEFINE ( BUILD_NUMBER_FORMAT )
...
// To avoid user confusion, make sure the ASE version matches only if communication is possible
    ...
    #define MTA_DM_CLIENT_NET_MODULE_VERSION   0x100D
#else
