...
void CLuaManager::LoadCFunctions ( void )
{
    ...
    CLuaCFunctions::AddFunction ( "setHeatHazeEnabled", CLuaFunctionDefs::SetHeatHazeEnabled );
    CLuaCFunctions::AddFunction ( "getHeatHazeEnabled", CLuaFunctionDefs::GetHeatHazeEnabled );
