...
#define MTA_DM_BITSTREAM_VERSION    0x08
...
// Make MTA_DM_BUILDTAG_LONG_SVN
#ifdef SVN_REVISION
    #define MTA_DM_BUILDTAG_LONG_SVN    MTA_DM_BUILDTAG_LONG "-" SVN_REVISION
#else
    #define MTA_DM_BUILDTAG_LONG_SVN    MTA_DM_BUILDTAG_LONG
#endif
