...
#define _SERVER_NET_MODULE_VERSION      0x034       // (0x000 - 0xfff) Lvl9 wizards only
#define _NETCODE_VERSION                0x1BA       // (0x000 - 0xfff) Increment when net messages change (pre-release)
