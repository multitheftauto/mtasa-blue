...
CResourceScriptItem::CResourceScriptItem ( CResource * resource, const char * szShortName, const char * szResourceFileName, bool bValidateContent ) : CResourceFile ( resource, szShortName, szResourceFileName, bValidateContent )
{
