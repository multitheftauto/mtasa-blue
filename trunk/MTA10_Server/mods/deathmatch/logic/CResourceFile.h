...
protected:
	...
	bool					    m_bValidateContent; // if true, check the file for issues such as deprecated function calls, or invalid graphic file data
    
public:
                                CResourceFile ( class CResource * resource, const char* szShortName, const char* szResourceFileName, bool bValidateContent = true );
    ...
    bool                        ShouldValidateContent ( void ) { return m_bValidateContent; }
};
