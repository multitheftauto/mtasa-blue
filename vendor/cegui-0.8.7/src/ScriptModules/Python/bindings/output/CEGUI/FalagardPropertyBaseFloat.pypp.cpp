...
struct FalagardPropertyBase_less__float__greater__wrapper : CEGUI::FalagardPropertyBase< float >, bp::wrapper< CEGUI::FalagardPropertyBase< float > > {

    FalagardPropertyBase_less__float__greater__wrapper(::CEGUI::String const & name, ::CEGUI::String const & help, ::CEGUI::String const & initialValue, ::CEGUI::String const & origin, bool redrawOnWrite, bool layoutOnWrite, ::CEGUI::String const & fireEvent, ::CEGUI::String const & eventNamespace )
    : CEGUI::FalagardPropertyBase<float>( boost::ref(name), boost::ref(help), boost::ref(initialValue), boost::ref(origin), redrawOnWrite, layoutOnWrite, boost::ref(fireEvent), boost::ref(eventNamespace) )
      , bp::wrapper< CEGUI::FalagardPropertyBase< float > >(){
        // constructor
    
    }

    virtual void setNative_impl( ::CEGUI::PropertyReceiver * receiver, float const arg1 ){
        if( bp::override func_setNative_impl = this->get_override( "setNative_impl" ) )
            func_setNative_impl( boost::python::ptr(receiver), arg1 );
        else{
            this->CEGUI::FalagardPropertyBase< float >::setNative_impl( boost::python::ptr(receiver), arg1 );
        }
    }
    
    virtual void default_setNative_impl( ::CEGUI::PropertyReceiver * receiver, float const arg1 ){
        CEGUI::FalagardPropertyBase< float >::setNative_impl( boost::python::ptr(receiver), arg1 );
    }
...
void register_FalagardPropertyBaseFloat_class(){
    ...
    { //::CEGUI::FalagardPropertyBase< float >
        typedef bp::class_< FalagardPropertyBase_less__float__greater__wrapper, bp::bases< CEGUI::PropertyDefinitionBase, CEGUI::TypedProperty< float > >, boost::noncopyable > FalagardPropertyBaseFloat_exposer_t;
        FalagardPropertyBaseFloat_exposer_t FalagardPropertyBaseFloat_exposer = FalagardPropertyBaseFloat_exposer_t( "FalagardPropertyBaseFloat", bp::init< CEGUI::String const &, CEGUI::String const &, CEGUI::String const &, CEGUI::String const &, bool, bool, CEGUI::String const &, CEGUI::String const & >(( bp::arg("name"), bp::arg("help"), bp::arg("initialValue"), bp::arg("origin"), bp::arg("redrawOnWrite"), bp::arg("layoutOnWrite"), bp::arg("fireEvent"), bp::arg("eventNamespace") )) );
        bp::scope FalagardPropertyBaseFloat_scope( FalagardPropertyBaseFloat_exposer );
        { //::CEGUI::FalagardPropertyBase< float >::setNative_impl
        
            typedef CEGUI::FalagardPropertyBase< float > exported_class_t;
            typedef void ( FalagardPropertyBase_less__float__greater__wrapper::*setNative_impl_function_type )( ::CEGUI::PropertyReceiver *,float const ) ;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "setNative_impl"
                , setNative_impl_function_type( &FalagardPropertyBase_less__float__greater__wrapper::default_setNative_impl )
        ...
        { //::CEGUI::Property::doesWriteXML
            ...
            typedef bool ( FalagardPropertyBase_less__float__greater__wrapper::*default_doesWriteXML_function_type )(  ) const;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "doesWriteXML"
                , doesWriteXML_function_type(&::CEGUI::Property::doesWriteXML)
                , default_doesWriteXML_function_type(&FalagardPropertyBase_less__float__greater__wrapper::default_doesWriteXML) );
        ...
        { //::CEGUI::TypedProperty< float >::get
            ...
            typedef ::CEGUI::String ( FalagardPropertyBase_less__float__greater__wrapper::*default_get_function_type )( ::CEGUI::PropertyReceiver const * ) const;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "get"
                , get_function_type(&::CEGUI::TypedProperty< float >::get)
                , default_get_function_type(&FalagardPropertyBase_less__float__greater__wrapper::default_get)
                , ( bp::arg("receiver") ) );
        ...
        { //::CEGUI::Property::getDefault
            ...
            typedef ::CEGUI::String ( FalagardPropertyBase_less__float__greater__wrapper::*default_getDefault_function_type )( ::CEGUI::PropertyReceiver const * ) const;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "getDefault"
                , getDefault_function_type(&::CEGUI::Property::getDefault)
                , default_getDefault_function_type(&FalagardPropertyBase_less__float__greater__wrapper::default_getDefault)
                , ( bp::arg("receiver") ) );
        ...
        { //::CEGUI::TypedProperty< float >::getNative
            ...
            typedef float ( FalagardPropertyBase_less__float__greater__wrapper::*default_getNative_function_type )( ::CEGUI::PropertyReceiver const * ) const;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "getNative"
                , getNative_function_type(&::CEGUI::TypedProperty< float >::getNative)
                , default_getNative_function_type(&FalagardPropertyBase_less__float__greater__wrapper::default_getNative)
                , ( bp::arg("receiver") ) );
        ...
        { //::CEGUI::TypedProperty< float >::getNative_impl
            ...
            typedef CEGUI::FalagardPropertyBase< float > exported_class_t;
            typedef float ( FalagardPropertyBase_less__float__greater__wrapper::*getNative_impl_function_type )( ::CEGUI::PropertyReceiver const * ) const;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "getNative_impl"
                , getNative_impl_function_type( &FalagardPropertyBase_less__float__greater__wrapper::getNative_impl )
                , ( bp::arg("receiver") ) );
        ...
        { //::CEGUI::Property::initialisePropertyReceiver
            ...
            typedef void ( FalagardPropertyBase_less__float__greater__wrapper::*default_initialisePropertyReceiver_function_type )( ::CEGUI::PropertyReceiver * ) const;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "initialisePropertyReceiver"
                , initialisePropertyReceiver_function_type(&::CEGUI::Property::initialisePropertyReceiver)
                , default_initialisePropertyReceiver_function_type(&FalagardPropertyBase_less__float__greater__wrapper::default_initialisePropertyReceiver)
                , ( bp::arg("arg0") ) );
        ...
        { //::CEGUI::Property::isDefault
            ...
            typedef bool ( FalagardPropertyBase_less__float__greater__wrapper::*default_isDefault_function_type )( ::CEGUI::PropertyReceiver const * ) const;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "isDefault"
                , isDefault_function_type(&::CEGUI::Property::isDefault)
                , default_isDefault_function_type(&FalagardPropertyBase_less__float__greater__wrapper::default_isDefault)
                , ( bp::arg("receiver") ) );
        ...
        { //::CEGUI::Property::isReadable
            ...
            typedef bool ( FalagardPropertyBase_less__float__greater__wrapper::*default_isReadable_function_type )(  ) const;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "isReadable"
                , isReadable_function_type(&::CEGUI::Property::isReadable)
                , default_isReadable_function_type(&FalagardPropertyBase_less__float__greater__wrapper::default_isReadable) );
        
        }
        { //::CEGUI::Property::isWritable
        
            typedef bool ( ::CEGUI::Property::*isWritable_function_type )(  ) const;
            typedef bool ( FalagardPropertyBase_less__float__greater__wrapper::*default_isWritable_function_type )(  ) const;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "isWritable"
                , isWritable_function_type(&::CEGUI::Property::isWritable)
                , default_isWritable_function_type(&FalagardPropertyBase_less__float__greater__wrapper::default_isWritable) );
        ...
        { //::CEGUI::TypedProperty< float >::set
            ...
            typedef void ( FalagardPropertyBase_less__float__greater__wrapper::*default_set_function_type )( ::CEGUI::PropertyReceiver *,::CEGUI::String const & ) ;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "set"
                , set_function_type(&::CEGUI::TypedProperty< float >::set)
                , default_set_function_type(&FalagardPropertyBase_less__float__greater__wrapper::default_set)
        ...
        { //::CEGUI::TypedProperty< float >::setNative
            ...
            typedef void ( FalagardPropertyBase_less__float__greater__wrapper::*default_setNative_function_type )( ::CEGUI::PropertyReceiver *,float const ) ;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "setNative"
                , setNative_function_type(&::CEGUI::TypedProperty< float >::setNative)
                , default_setNative_function_type(&FalagardPropertyBase_less__float__greater__wrapper::default_setNative)
                , ( bp::arg("receiver"), bp::arg("value") ) );
        
        }
        { //::CEGUI::PropertyDefinitionBase::writeDefinitionXMLAttributes
        
            typedef void ( FalagardPropertyBase_less__float__greater__wrapper::*writeDefinitionXMLAttributes_function_type )( ::CEGUI::XMLSerializer & ) const;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "writeDefinitionXMLAttributes"
                , writeDefinitionXMLAttributes_function_type( &FalagardPropertyBase_less__float__greater__wrapper::default_writeDefinitionXMLAttributes )
                , ( bp::arg("xml_stream") )
                , "*!\n\
                \n\
        ...
        { //::CEGUI::PropertyDefinitionBase::writeDefinitionXMLElementType
            ...
            typedef void ( FalagardPropertyBase_less__float__greater__wrapper::*writeDefinitionXMLElementType_function_type )( ::CEGUI::XMLSerializer & ) const;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "writeDefinitionXMLElementType"
                , writeDefinitionXMLElementType_function_type( &FalagardPropertyBase_less__float__greater__wrapper::writeDefinitionXMLElementType )
                , ( bp::arg("xml_stream") )
                , "*!\n\
                \n\
        ...
        { //::CEGUI::PropertyDefinitionBase::writeDefinitionXMLToStream
            ...
            typedef void ( FalagardPropertyBase_less__float__greater__wrapper::*default_writeDefinitionXMLToStream_function_type )( ::CEGUI::XMLSerializer & ) const;
            ...
            FalagardPropertyBaseFloat_exposer.def( 
                ...
                , default_writeDefinitionXMLToStream_function_type(&FalagardPropertyBase_less__float__greater__wrapper::default_writeDefinitionXMLToStream)
                , ( bp::arg("xml_stream") ) );
        ...
        { //::CEGUI::Property::writeXMLToStream
            ...
            typedef void ( FalagardPropertyBase_less__float__greater__wrapper::*default_writeXMLToStream_function_type )( ::CEGUI::PropertyReceiver const *,::CEGUI::XMLSerializer & ) const;
            
            FalagardPropertyBaseFloat_exposer.def( 
                "writeXMLToStream"
                , writeXMLToStream_function_type(&::CEGUI::Property::writeXMLToStream)
                , default_writeXMLToStream_function_type(&FalagardPropertyBase_less__float__greater__wrapper::default_writeXMLToStream)
