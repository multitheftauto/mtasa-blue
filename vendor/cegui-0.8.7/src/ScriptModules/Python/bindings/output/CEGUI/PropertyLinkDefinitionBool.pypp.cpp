...
struct PropertyLinkDefinition_less__bool__greater__wrapper : CEGUI::PropertyLinkDefinition< bool >, bp::wrapper< CEGUI::PropertyLinkDefinition< bool > > {

    PropertyLinkDefinition_less__bool__greater__wrapper(CEGUI::PropertyLinkDefinition<bool> const & arg )
    : CEGUI::PropertyLinkDefinition<bool>( arg )
      , bp::wrapper< CEGUI::PropertyLinkDefinition< bool > >(){
        // copy constructor
        
    }

    PropertyLinkDefinition_less__bool__greater__wrapper(::CEGUI::String const & propertyName, ::CEGUI::String const & widgetName, ::CEGUI::String const & targetProperty, ::CEGUI::String const & initialValue, ::CEGUI::String const & origin, bool redrawOnWrite, bool layoutOnWrite, ::CEGUI::String const & fireEvent, ::CEGUI::String const & eventNamespace )
    : CEGUI::PropertyLinkDefinition<bool>( boost::ref(propertyName), boost::ref(widgetName), boost::ref(targetProperty), boost::ref(initialValue), boost::ref(origin), redrawOnWrite, layoutOnWrite, boost::ref(fireEvent), boost::ref(eventNamespace) )
      , bp::wrapper< CEGUI::PropertyLinkDefinition< bool > >(){
        // constructor
    ...
    virtual ::CEGUI::Property * clone(  ) const  {
        if( bp::override func_clone = this->get_override( "clone" ) )
            ...
            return this->CEGUI::PropertyLinkDefinition< bool >::clone(  );
        }
    }
    
    ::CEGUI::Property * default_clone(  ) const  {
        return CEGUI::PropertyLinkDefinition< bool >::clone( );
    }
    ...
    virtual bool getNative_impl( ::CEGUI::PropertyReceiver const * receiver ) const {
        if( bp::override func_getNative_impl = this->get_override( "getNative_impl" ) )
            ...
            return this->CEGUI::PropertyLinkDefinition< bool >::getNative_impl( boost::python::ptr(receiver) );
        }
    }
    
    virtual bool default_getNative_impl( ::CEGUI::PropertyReceiver const * receiver ) const {
        return CEGUI::PropertyLinkDefinition< bool >::getNative_impl( boost::python::ptr(receiver) );
    }

    ::CEGUI::Window const * getTargetWindow( ::CEGUI::PropertyReceiver const * receiver, ::CEGUI::String const & name ) const {
        return CEGUI::PropertyLinkDefinition< bool >::getTargetWindow( boost::python::ptr(receiver), boost::ref(name) );
    }
    ...
    virtual void initialisePropertyReceiver( ::CEGUI::PropertyReceiver * receiver ) const  {
        if( bp::override func_initialisePropertyReceiver = this->get_override( "initialisePropertyReceiver" ) )
            ...
            this->CEGUI::PropertyLinkDefinition< bool >::initialisePropertyReceiver( boost::python::ptr(receiver) );
        }
    }
    
    void default_initialisePropertyReceiver( ::CEGUI::PropertyReceiver * receiver ) const  {
        CEGUI::PropertyLinkDefinition< bool >::initialisePropertyReceiver( boost::python::ptr(receiver) );
    }
    ...
    virtual void setNative_impl( ::CEGUI::PropertyReceiver * receiver, bool const value ){
        if( bp::override func_setNative_impl = this->get_override( "setNative_impl" ) )
            ...
            this->CEGUI::PropertyLinkDefinition< bool >::setNative_impl( boost::python::ptr(receiver), value );
        }
    }
    
    virtual void default_setNative_impl( ::CEGUI::PropertyReceiver * receiver, bool const value ){
        CEGUI::PropertyLinkDefinition< bool >::setNative_impl( boost::python::ptr(receiver), value );
    }

    void updateLinkTargets( ::CEGUI::PropertyReceiver * receiver, bool const value ) const {
        CEGUI::PropertyLinkDefinition< bool >::updateLinkTargets( boost::python::ptr(receiver), value );
    }

    void writeDefinitionXMLAdditionalAttributes( ::CEGUI::XMLSerializer & xml_stream ) const {
        CEGUI::PropertyLinkDefinition< bool >::writeDefinitionXMLAdditionalAttributes( boost::ref(xml_stream) );
    }
    ...
    virtual void writeDefinitionXMLElementType( ::CEGUI::XMLSerializer & xml_stream ) const {
        if( bp::override func_writeDefinitionXMLElementType = this->get_override( "writeDefinitionXMLElementType" ) )
            ...
            this->CEGUI::PropertyLinkDefinition< bool >::writeDefinitionXMLElementType( boost::ref(xml_stream) );
        }
    }
    
    virtual void default_writeDefinitionXMLElementType( ::CEGUI::XMLSerializer & xml_stream ) const {
        CEGUI::PropertyLinkDefinition< bool >::writeDefinitionXMLElementType( boost::ref(xml_stream) );
    }

    void writeFalagardXMLAttributes( ::CEGUI::XMLSerializer & xml_stream ) const {
        CEGUI::PropertyLinkDefinition< bool >::writeFalagardXMLAttributes( boost::ref(xml_stream) );
    }
...
void register_PropertyLinkDefinitionBool_class(){
    ...
    { //::CEGUI::PropertyLinkDefinition< bool >
        typedef bp::class_< PropertyLinkDefinition_less__bool__greater__wrapper, bp::bases< CEGUI::FalagardPropertyBase< bool > > > PropertyLinkDefinitionBool_exposer_t;
        PropertyLinkDefinitionBool_exposer_t PropertyLinkDefinitionBool_exposer = PropertyLinkDefinitionBool_exposer_t( "PropertyLinkDefinitionBool", bp::init< CEGUI::String const &, CEGUI::String const &, CEGUI::String const &, CEGUI::String const &, CEGUI::String const &, bool, bool, CEGUI::String const &, CEGUI::String const & >(( bp::arg("propertyName"), bp::arg("widgetName"), bp::arg("targetProperty"), bp::arg("initialValue"), bp::arg("origin"), bp::arg("redrawOnWrite"), bp::arg("layoutOnWrite"), bp::arg("fireEvent"), bp::arg("eventNamespace") )) );
        bp::scope PropertyLinkDefinitionBool_scope( PropertyLinkDefinitionBool_exposer );
        { //::CEGUI::PropertyLinkDefinition< bool >::addLinkTarget
        
            typedef CEGUI::PropertyLinkDefinition< bool > exported_class_t;
            typedef void ( exported_class_t::*addLinkTarget_function_type )( ::CEGUI::String const &,::CEGUI::String const & ) ;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "addLinkTarget"
                , addLinkTarget_function_type( &::CEGUI::PropertyLinkDefinition< bool >::addLinkTarget )
                , ( bp::arg("widget"), bp::arg("property") )
                , "------------------------------------------------------------------------\n\
            ! add a new link target to  property on  widget (name).\n" );
        
        }
        { //::CEGUI::PropertyLinkDefinition< bool >::clearLinkTargets
            ...
            PropertyLinkDefinitionBool_exposer.def( 
                "clearLinkTargets"
                , clearLinkTargets_function_type( &::CEGUI::PropertyLinkDefinition< bool >::clearLinkTargets )
                , "------------------------------------------------------------------------\n\
            ! clear all link targets from this link definition.\n" );
        
        }
        { //::CEGUI::PropertyLinkDefinition< bool >::clone
        
            typedef CEGUI::PropertyLinkDefinition< bool > exported_class_t;
            typedef ::CEGUI::Property * ( exported_class_t::*clone_function_type )(  ) const;
            typedef ::CEGUI::Property * ( PropertyLinkDefinition_less__bool__greater__wrapper::*default_clone_function_type )(  ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "clone"
                , clone_function_type(&::CEGUI::PropertyLinkDefinition< bool >::clone)
                , default_clone_function_type(&PropertyLinkDefinition_less__bool__greater__wrapper::default_clone)
                , bp::return_value_policy< bp::reference_existing_object >() );
        
        }
        { //::CEGUI::PropertyLinkDefinition< bool >::getLinkTargetIterator
            ...
            PropertyLinkDefinitionBool_exposer.def( 
                ...
                , getLinkTargetIterator_function_type( &::CEGUI::PropertyLinkDefinition< bool >::getLinkTargetIterator ) );
        
        }
        { //::CEGUI::PropertyLinkDefinition< bool >::getNative_impl
        
            typedef CEGUI::PropertyLinkDefinition< bool > exported_class_t;
            typedef bool ( PropertyLinkDefinition_less__bool__greater__wrapper::*getNative_impl_function_type )( ::CEGUI::PropertyReceiver const * ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "getNative_impl"
                , getNative_impl_function_type( &PropertyLinkDefinition_less__bool__greater__wrapper::default_getNative_impl )
                , ( bp::arg("receiver") )
                , "override members from FalagardPropertyBase\n\
            ------------------------------------------------------------------------\n" );
        
        }
        { //::CEGUI::PropertyLinkDefinition< bool >::getTargetWindow
        
            typedef CEGUI::PropertyLinkDefinition< bool > exported_class_t;
            typedef ::CEGUI::Window const * ( PropertyLinkDefinition_less__bool__greater__wrapper::*getTargetWindow_function_type )( ::CEGUI::PropertyReceiver const *,::CEGUI::String const & ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "getTargetWindow"
                , getTargetWindow_function_type( &PropertyLinkDefinition_less__bool__greater__wrapper::getTargetWindow )
        ...
        { //::CEGUI::PropertyLinkDefinition< bool >::getTargetWindow
            ...
            typedef CEGUI::PropertyLinkDefinition< bool > exported_class_t;
            typedef ::CEGUI::Window * ( PropertyLinkDefinition_less__bool__greater__wrapper::*getTargetWindow_function_type )( ::CEGUI::PropertyReceiver *,::CEGUI::String const & ) const;
        ...
        { //::CEGUI::PropertyLinkDefinition< bool >::initialisePropertyReceiver
        
            typedef CEGUI::PropertyLinkDefinition< bool > exported_class_t;
            typedef void ( exported_class_t::*initialisePropertyReceiver_function_type )( ::CEGUI::PropertyReceiver * ) const;
            typedef void ( PropertyLinkDefinition_less__bool__greater__wrapper::*default_initialisePropertyReceiver_function_type )( ::CEGUI::PropertyReceiver * ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "initialisePropertyReceiver"
                , initialisePropertyReceiver_function_type(&::CEGUI::PropertyLinkDefinition< bool >::initialisePropertyReceiver)
                , default_initialisePropertyReceiver_function_type(&PropertyLinkDefinition_less__bool__greater__wrapper::default_initialisePropertyReceiver)
                , ( bp::arg("receiver") ) );
        
        }
        { //::CEGUI::PropertyLinkDefinition< bool >::isTargetProperty
            ...
            PropertyLinkDefinitionBool_exposer.def( 
                "isTargetProperty"
                , isTargetProperty_function_type( &::CEGUI::PropertyLinkDefinition< bool >::isTargetProperty )
                , ( bp::arg("widget"), bp::arg("property") )
                , "------------------------------------------------------------------------\n\
        ...
        { //::CEGUI::PropertyLinkDefinition< bool >::setNative_impl
        
            typedef CEGUI::PropertyLinkDefinition< bool > exported_class_t;
            typedef void ( PropertyLinkDefinition_less__bool__greater__wrapper::*setNative_impl_function_type )( ::CEGUI::PropertyReceiver *,bool const ) ;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "setNative_impl"
                , setNative_impl_function_type( &PropertyLinkDefinition_less__bool__greater__wrapper::default_setNative_impl )
                , ( bp::arg("receiver"), bp::arg("value") )
                , "------------------------------------------------------------------------\n" );
        
        }
        { //::CEGUI::PropertyLinkDefinition< bool >::updateLinkTargets
        
            typedef CEGUI::PropertyLinkDefinition< bool > exported_class_t;
            typedef void ( PropertyLinkDefinition_less__bool__greater__wrapper::*updateLinkTargets_function_type )( ::CEGUI::PropertyReceiver *,bool const ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "updateLinkTargets"
                , updateLinkTargets_function_type( &PropertyLinkDefinition_less__bool__greater__wrapper::updateLinkTargets )
                , ( bp::arg("receiver"), bp::arg("value") )
                , "------------------------------------------------------------------------\n" );
        
        }
        { //::CEGUI::PropertyLinkDefinition< bool >::writeDefinitionXMLAdditionalAttributes
        
            typedef CEGUI::PropertyLinkDefinition< bool > exported_class_t;
            typedef void ( PropertyLinkDefinition_less__bool__greater__wrapper::*writeDefinitionXMLAdditionalAttributes_function_type )( ::CEGUI::XMLSerializer & ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "writeDefinitionXMLAdditionalAttributes"
                , writeDefinitionXMLAdditionalAttributes_function_type( &PropertyLinkDefinition_less__bool__greater__wrapper::writeDefinitionXMLAdditionalAttributes )
                , ( bp::arg("xml_stream") )
                , "------------------------------------------------------------------------\n" );
        
        }
        { //::CEGUI::PropertyLinkDefinition< bool >::writeDefinitionXMLElementType
        
            typedef CEGUI::PropertyLinkDefinition< bool > exported_class_t;
            typedef void ( PropertyLinkDefinition_less__bool__greater__wrapper::*writeDefinitionXMLElementType_function_type )( ::CEGUI::XMLSerializer & ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "writeDefinitionXMLElementType"
                , writeDefinitionXMLElementType_function_type( &PropertyLinkDefinition_less__bool__greater__wrapper::default_writeDefinitionXMLElementType )
                , ( bp::arg("xml_stream") )
                , "------------------------------------------------------------------------\n" );
        
        }
        { //::CEGUI::PropertyLinkDefinition< bool >::writeFalagardXMLAttributes
        
            typedef CEGUI::PropertyLinkDefinition< bool > exported_class_t;
            typedef void ( PropertyLinkDefinition_less__bool__greater__wrapper::*writeFalagardXMLAttributes_function_type )( ::CEGUI::XMLSerializer & ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "writeFalagardXMLAttributes"
                , writeFalagardXMLAttributes_function_type( &PropertyLinkDefinition_less__bool__greater__wrapper::writeFalagardXMLAttributes )
                , ( bp::arg("xml_stream") )
                , "------------------------------------------------------------------------\n" );
        ...
        { //::CEGUI::Property::doesWriteXML
            ...
            typedef bool ( PropertyLinkDefinition_less__bool__greater__wrapper::*default_doesWriteXML_function_type )(  ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "doesWriteXML"
                , doesWriteXML_function_type(&::CEGUI::Property::doesWriteXML)
                , default_doesWriteXML_function_type(&PropertyLinkDefinition_less__bool__greater__wrapper::default_doesWriteXML) );
        ...
        { //::CEGUI::TypedProperty< bool >::get
            ...
            typedef ::CEGUI::String ( PropertyLinkDefinition_less__bool__greater__wrapper::*default_get_function_type )( ::CEGUI::PropertyReceiver const * ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "get"
                , get_function_type(&::CEGUI::TypedProperty< bool >::get)
                , default_get_function_type(&PropertyLinkDefinition_less__bool__greater__wrapper::default_get)
                , ( bp::arg("receiver") ) );
        ...
        { //::CEGUI::Property::getDefault
            ...
            typedef ::CEGUI::String ( PropertyLinkDefinition_less__bool__greater__wrapper::*default_getDefault_function_type )( ::CEGUI::PropertyReceiver const * ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "getDefault"
                , getDefault_function_type(&::CEGUI::Property::getDefault)
                , default_getDefault_function_type(&PropertyLinkDefinition_less__bool__greater__wrapper::default_getDefault)
                , ( bp::arg("receiver") ) );
        ...
        { //::CEGUI::TypedProperty< bool >::getNative
            ...
            typedef bool ( PropertyLinkDefinition_less__bool__greater__wrapper::*default_getNative_function_type )( ::CEGUI::PropertyReceiver const * ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "getNative"
                , getNative_function_type(&::CEGUI::TypedProperty< bool >::getNative)
                , default_getNative_function_type(&PropertyLinkDefinition_less__bool__greater__wrapper::default_getNative)
                , ( bp::arg("receiver") ) );
        ...
        { //::CEGUI::Property::isDefault
            ...
            typedef bool ( PropertyLinkDefinition_less__bool__greater__wrapper::*default_isDefault_function_type )( ::CEGUI::PropertyReceiver const * ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "isDefault"
                , isDefault_function_type(&::CEGUI::Property::isDefault)
                , default_isDefault_function_type(&PropertyLinkDefinition_less__bool__greater__wrapper::default_isDefault)
                , ( bp::arg("receiver") ) );
        ...
        { //::CEGUI::Property::isReadable
            ...
            typedef bool ( PropertyLinkDefinition_less__bool__greater__wrapper::*default_isReadable_function_type )(  ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "isReadable"
                , isReadable_function_type(&::CEGUI::Property::isReadable)
                , default_isReadable_function_type(&PropertyLinkDefinition_less__bool__greater__wrapper::default_isReadable) );
        
        }
        { //::CEGUI::Property::isWritable
        
            typedef bool ( ::CEGUI::Property::*isWritable_function_type )(  ) const;
            typedef bool ( PropertyLinkDefinition_less__bool__greater__wrapper::*default_isWritable_function_type )(  ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "isWritable"
                , isWritable_function_type(&::CEGUI::Property::isWritable)
                , default_isWritable_function_type(&PropertyLinkDefinition_less__bool__greater__wrapper::default_isWritable) );
        ...
        { //::CEGUI::TypedProperty< bool >::set
            ...
            typedef void ( PropertyLinkDefinition_less__bool__greater__wrapper::*default_set_function_type )( ::CEGUI::PropertyReceiver *,::CEGUI::String const & ) ;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "set"
                , set_function_type(&::CEGUI::TypedProperty< bool >::set)
                , default_set_function_type(&PropertyLinkDefinition_less__bool__greater__wrapper::default_set)
                , ( bp::arg("receiver"), bp::arg("value") ) );
        ...
        { //::CEGUI::TypedProperty< bool >::setNative
            ...
            typedef void ( PropertyLinkDefinition_less__bool__greater__wrapper::*default_setNative_function_type )( ::CEGUI::PropertyReceiver *,bool const ) ;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "setNative"
                , setNative_function_type(&::CEGUI::TypedProperty< bool >::setNative)
                , default_setNative_function_type(&PropertyLinkDefinition_less__bool__greater__wrapper::default_setNative)
                , ( bp::arg("receiver"), bp::arg("value") ) );
        
        }
        { //::CEGUI::PropertyDefinitionBase::writeDefinitionXMLAttributes
        
            typedef void ( PropertyLinkDefinition_less__bool__greater__wrapper::*writeDefinitionXMLAttributes_function_type )( ::CEGUI::XMLSerializer & ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "writeDefinitionXMLAttributes"
                , writeDefinitionXMLAttributes_function_type( &PropertyLinkDefinition_less__bool__greater__wrapper::default_writeDefinitionXMLAttributes )
                , ( bp::arg("xml_stream") )
                , "*!\n\
                \n\
        ...
        { //::CEGUI::PropertyDefinitionBase::writeDefinitionXMLToStream
            ...
            typedef void ( PropertyLinkDefinition_less__bool__greater__wrapper::*default_writeDefinitionXMLToStream_function_type )( ::CEGUI::XMLSerializer & ) const;
            ...
            PropertyLinkDefinitionBool_exposer.def( 
                ...
                , default_writeDefinitionXMLToStream_function_type(&PropertyLinkDefinition_less__bool__greater__wrapper::default_writeDefinitionXMLToStream)
                , ( bp::arg("xml_stream") ) );
        ...
        { //::CEGUI::Property::writeXMLToStream
            ...
            typedef void ( PropertyLinkDefinition_less__bool__greater__wrapper::*default_writeXMLToStream_function_type )( ::CEGUI::PropertyReceiver const *,::CEGUI::XMLSerializer & ) const;
            
            PropertyLinkDefinitionBool_exposer.def( 
                "writeXMLToStream"
                , writeXMLToStream_function_type(&::CEGUI::Property::writeXMLToStream)
                , default_writeXMLToStream_function_type(&PropertyLinkDefinition_less__bool__greater__wrapper::default_writeXMLToStream)
