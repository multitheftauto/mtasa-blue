...
enum ResponseCode {
	...
	HTTPRESPONSECODE_405_METHODNOTALLOWED = 405,
	HTTPRESPONSECODE_406_NOTACCEPTABLE = 406,

	HTTPRESPONSECODE_500_INTERNALSERVERERROR = 500,
	HTTPRESPONSECODE_501_NOTIMPLEMENTED = 501,
	HTTPRESPONSECODE_502_BADGATEWAY = 502,
};
