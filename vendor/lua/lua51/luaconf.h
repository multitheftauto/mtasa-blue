...
*/
#define LUA_INTEGER	int // Take int instead of ptrdiff_t to be consistent with Luau
...
*/
#define LUAI_EXTRASPACE		sizeof(size_t)
...
*/
#define luai_userstateopen(L)		*((size_t*)L - 0x1) = 0x5989C266
#define luai_userstateclose(L)		((void)L)
#define luai_userstatethread(L,L1)	*((size_t*)L1 - 0x1) = *((size_t*)L - 0x1)
