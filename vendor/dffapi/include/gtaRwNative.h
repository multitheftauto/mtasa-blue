...
typedef struct gtaNativePS2VIFCodeNop    gtaNativePS2VIFCodeNop;
typedef struct gtaNativePS2VIFCodeStcycl gtaNativePS2VIFCodeStcycl;
typedef struct gtaNativePS2VIFCodeOffset gtaNativePS2VIFCodeOffset;
typedef union gtaNativePS2DMATag         gtaNativePS2DMATag;
typedef struct gtaNativeOGlVertexElement gtaNativeOGlVertexElement;
typedef union gtaNativePS2VIFPacket      gtaNativePS2VIFPacket;
typedef union gtaNativePS2VIFCode        gtaNativePS2VIFCode;
typedef struct gtaNativeOGl              gtaNativeOGl;
typedef struct gtaNativePS2Mesh          gtaNativePS2Mesh;
typedef struct gtaNativeOGlCompressedNormal    gtaNativeOGlCompressedNormal;
typedef struct gtaNativeOGlCompressedTexCoords gtaNativeOGlCompressedTexCoords;
