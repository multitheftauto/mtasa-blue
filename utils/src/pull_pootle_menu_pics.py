...
parser.add_option("-L", "--languages",dest="languages", 
            help="A comma delimited list of languages to pull from Pootle", default='ar,zh_CN,hr,cs,de,es,et,fr,hu,it,ja,lt,lv,nb,nl,pl,pt_BR,ro,ru,sk,sl,sv,tr')
...
# e.g.:
# http://translate.mtasa.com/export/mainmenu/hr/mainmenu.po
# http://translate.mtasa.com/download/hr/mainmenu/mainmenu.po
...
for lang in (options.languages).replace(" ","").split(","):
    ...
    while True:
        ...
        req = urllib2.Request(alturl, headers=header)
