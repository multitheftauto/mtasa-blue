...
class CLuaPhysicsCapsuleShape : public CLuaPhysicsConvexShape, CShapeHolder<btCapsuleShape>
{
public:
    ...
    btCapsuleShape*             GetBtShape() const { return (btCapsuleShape*)InternalGetBtShape(); }
};
