...
{
public:
    CLuaPhysicsbtGeneric6DofSpring2Constraint(CBulletPhysics* pPhysics, CLuaPhysicsRigidBody* pRigidBody, bool bDisableCollisionsBetweenLinkedBodies = true);
    CLuaPhysicsbtGeneric6DofSpring2Constraint(CBulletPhysics* pPhysics, CLuaPhysicsRigidBody* pRigidBodyA, CLuaPhysicsRigidBody* pRigidBodyB,
