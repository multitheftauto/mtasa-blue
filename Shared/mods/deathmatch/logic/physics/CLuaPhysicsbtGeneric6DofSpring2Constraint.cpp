...
CLuaPhysicsbtGeneric6DofSpring2Constraint::CLuaPhysicsbtGeneric6DofSpring2Constraint(CBulletPhysics* pPhysics, CLuaPhysicsRigidBody* pRigidBody,
                                                                                     bool bDisableCollisionsBetweenLinkedBodies)
    : CLuaPhysicsConstraint(pPhysics, pRigidBody, bDisableCollisionsBetweenLinkedBodies)
{

}
CLuaPhysicsbtGeneric6DofSpring2Constraint::CLuaPhysicsbtGeneric6DofSpring2Constraint(CBulletPhysics* pPhysics, CLuaPhysicsRigidBody* pRigidBodyA,
