...
ELEMENT_SHADER,
ELEMENT_TEXTURE,
ADD_ENUM(eElementType::ELEMENT_SOUND, "sound")
ADD_ENUM(eElementType::ELEMENT_CONSOLE, "spawnpoint")
ADD_ENUM(eElementType::ELEMENT_PROJECTILE, "projectile")
ADD_ENUM(eElementType::ELEMENT_EFFECT, "effect")
ADD_ENUM(eElementType::ELEMENT_LIGHT, "light")
ADD_ENUM(eElementType::ELEMENT_SEARCHLIGHT, "searchlight")
ADD_ENUM(eElementType::ELEMENT_SHADER, "shader")
ADD_ENUM(eElementType::ELEMENT_TEXTURE, "texture")

*/

IMPLEMENT_ENUM_BEGIN(EElementCountType)
ADD_ENUM(EElementCountType::ELEMENT_PLAYER, "player")
ADD_ENUM(EElementCountType::ELEMENT_PED, "ped")
ADD_ENUM(EElementCountType::ELEMENT_WATER, "water")
ADD_ENUM(EElementCountType::ELEMENT_VEHICLE, "vehicle")
ADD_ENUM(EElementCountType::ELEMENT_OBJECT, "object")
ADD_ENUM(EElementCountType::ELEMENT_PICKUP, "pickup")
ADD_ENUM(EElementCountType::ELEMENT_MARKER, "marker")
ADD_ENUM(EElementCountType::ELEMENT_COLSHAPE, "colshape")
ADD_ENUM(EElementCountType::ELEMENT_BLIP, "blip")
ADD_ENUM(EElementCountType::ELEMENT_RADARAREA, "radararea")
ADD_ENUM(EElementCountType::ELEMENT_TEAM, "team")
