...
IMPLEMENT_ENUM_CLASS_BEGIN(EThreadState)
ADD_ENUM(EThreadState::BUSY, "busy")
ADD_ENUM(EThreadState::DEAD, "dead")
ADD_ENUM(EThreadState::FAILURE, "failure")
ADD_ENUM(EThreadState::FINISHED, "finished")
ADD_ENUM(EThreadState::IDLE, "idle")
ADD_ENUM(EThreadState::INITIALIZING, "initializing")
ADD_ENUM(EThreadState::LOADED, "loaded")
ADD_ENUM(EThreadState::READY, "ready")
IMPLEMENT_ENUM_CLASS_END("thread-state")
