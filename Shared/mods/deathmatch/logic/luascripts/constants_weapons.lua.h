...
constants.WeaponSlot = _weaponSlot
constants.WeaponSkillName = _weaponSkillName
constants.WeaponSkillLevel = _weaponSkillLevel
constants.WeaponProperties = _weaponProperties
    )~LUA~";
}
