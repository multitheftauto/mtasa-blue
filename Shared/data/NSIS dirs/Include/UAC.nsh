...
!macro _UAC_IncL
!insertmacro _UAC_definemath __UAC_L "${__UAC_L_}" + 1
!macroend
...
!insertmacro _UAC_AsUser_GenOpGetReg ${outvar} SectionGet${datatype} ${secidx} ""
!macroend

!macro UAC_AsUser_GetGlobalVar var
!insertmacro _UAC_AsUser_GenOpGetReg ${var} StrCpy "" ${var}
!macroend
