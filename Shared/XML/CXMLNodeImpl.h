...
public:
    ...
    const std::list<std::unique_ptr<CXMLNode>>& GetChildren() override { return m_Children; }
    ...
    int  GetLine();
    bool IsValid() { return m_ulID != INVALID_XML_ID; };
    ...
    const std::list<std::unique_ptr<CXMLAttribute>>& GetAttributes() override { return m_Attributes; }
